...
const BASE_URL = process.env.BASE_URL || 'https://e0001089-5956-480e-9ebc-7b1a6c2ec0e7-00-3cydblgjeyjzl.worf.replit.dev';const SCREENSHOTS_DIR = path.join(__dirname, '../marketing-assets/screenshots');
