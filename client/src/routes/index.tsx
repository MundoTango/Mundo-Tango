...
export function RouteLoader() {
  ...
  const getRouteBundle = () => {
    ...
    if (location.startsWith("/feed") || location.startsWith("/dashboard") || location.startsWith("/home") || location.startsWith("/profile") || location.startsWith("/friends") || location.startsWith("/friend-requests") || location.startsWith("/friendship") || location.startsWith("/followers") || location.startsWith("/following") || location.startsWith("/messages") || location.startsWith("/notifications") || location.startsWith("/groups") || location.startsWith("/community") || location.startsWith("/map") || location.startsWith("/world") || location.startsWith("/city") || location.startsWith("/search") || location.startsWith("/favorites") || location.startsWith("/saved") || location.startsWith("/stories") || location.startsWith("/live") || location.startsWith("/invitations") || location.startsWith("/facebook") || location.startsWith("/closeness") || location.startsWith("/recommendations") || location.startsWith("/gamification") || location.startsWith("/leaderboard") || location.startsWith("/report") || location.startsWith("/reputation") || location.startsWith("/create-post") || location.startsWith("/professional-reputation")) {
      return <SocialRoutes />;
    }
