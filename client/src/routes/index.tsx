...
export function RouteLoader() {
  ...
  const getRouteBundle = () => {
    ...
    if (location.startsWith("/onboarding") || location.startsWith("/welcome")) {
      return <OnboardingRoutes />;
    }
    if (location.startsWith("/login") || location.startsWith("/register") || location.startsWith("/auth") || location.startsWith("/password") || location.startsWith("/email-verification") || location.startsWith("/2fa")) {
      return <AuthRoutes />;
    }
    if (location.startsWith("/talent") || location.startsWith("/enhanced-talent")) {
      return <TalentRoutes />;
    }
    if (location.startsWith("/events") || location.startsWith("/event-series") || location.startsWith("/my-events") || location.startsWith("/calendar") || location.startsWith("/travel")) {
      return <EventRoutes />;
    }
    if (location.startsWith("/feed") || location.startsWith("/dashboard") || location.startsWith("/home") || location.startsWith("/profile") || location.startsWith("/friends") || location.startsWith("/followers") || location.startsWith("/following") || location.startsWith("/messages") || location.startsWith("/notifications") || location.startsWith("/groups") || location.startsWith("/community") || location.startsWith("/map") || location.startsWith("/world") || location.startsWith("/city") || location.startsWith("/search") || location.startsWith("/favorites") || location.startsWith("/saved") || location.startsWith("/stories") || location.startsWith("/live") || location.startsWith("/invitations") || location.startsWith("/facebook") || location.startsWith("/closeness") || location.startsWith("/recommendations") || location.startsWith("/gamification") || location.startsWith("/leaderboard") || location.startsWith("/report") || location.startsWith("/reputation") || location.startsWith("/create-post")) {
      return <SocialRoutes />;
    }
    ...
    if (location === "/" || location.startsWith("/landing") || location.startsWith("/demos") || location.startsWith("/for-") || location.startsWith("/tango-roles") || location.startsWith("/support") || location.startsWith("/donate") || location.startsWith("/supporters") || location.startsWith("/volunteer") || location.startsWith("/ambassadors") || location.startsWith("/open-source") || location.startsWith("/about") || location.startsWith("/features") || location.startsWith("/testimonials") || location.startsWith("/discover") || location.startsWith("/pro") || location.startsWith("/terms") || location.startsWith("/privacy") || location.startsWith("/community-guidelines") || location.startsWith("/help") || location.startsWith("/contact") || location.startsWith("/h2ac")) {
