...
const GroupsPage = lazy(() => import("@/pages/FeatureArchivedPage"));
const GroupCreatePage = lazy(() => import("@/pages/GroupCreatePage"));
const GroupDetailsPage = lazy(() => import("@/pages/GroupDetailsPage"));
const GroupsDetailPage = lazy(() => import("@/pages/FeatureArchivedPage"));
...
const ProfessionalGroupsPage = lazy(() => import("@/pages/FeatureArchivedPage"));
const CustomGroupsPage = lazy(() => import("@/pages/FeatureArchivedPage"));
