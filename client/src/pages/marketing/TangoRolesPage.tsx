...
const categoryInfo = {
  dance: {
    title: "Dance Roles",
    description: "The heart of tango - leaders and followers who bring the dance to life",
    gradient: "from-blue-500/20 to-pink-500/20"
  },
  professional: {
    title: "Professional Roles",
    description: "The experts who teach, organize, and elevate the tango community",
    gradient: "from-green-500/20 to-blue-500/20"
  },
  creative: {
    title: "Creative Roles",
    description: "Artists, photographers, and creators who capture and express tango's beauty",
    gradient: "from-purple-500/20 to-pink-500/20"
  },
  community: {
    title: "Community Roles",
    description: "The builders and supporters who strengthen our global tango family",
    ...
    <SelfHealingErrorBoundary pageName="Tango Roles" fallbackRoute="/">
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <SEO 
          ...
          description="Explore 21+ tango roles from dancers to DJs, teachers to photographers. Find your place in the global tango community."
        />
        <motion.section
          ref={heroRef}
        ...
        >
          ...
          <div className="relative z-10 text-center px-8 max-w-6xl mx-auto">
            ...
            >
              Tango is more than dancing. From teachers to DJs, photographers to historians, discover the diverse roles that make our community thrive.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                Whether you dance, teach, perform, or support - there's a place for you in Mundo Tango.
              </p>
