...
function AmbassadorsPageContent() {
  ...
  const benefits = [
    { icon: Star, title: "Ambassador Badge", description: "Exclusive profile badge showing your ambassador status" },
    { icon: Gift, title: "Free Pro Membership", description: "Complimentary Pro features while you're an active ambassador" },
    { icon: Megaphone, title: "Event Promotion", description: "Priority promotion for events you organize or recommend" },
    { icon: Users, title: "Network Access", description: "Connect with ambassadors worldwide and share insights" },
    { icon: Calendar, title: "Early Access", description: "Be the first to try new features before public release" },
    { icon: Heart, title: "Community Impact", description: "Shape the tango community in your city" },
  ];
  ...
  const requirements = [
    ...
    "Share accurate local event information",
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <PublicNavbar />
      <SEO
        title="Become an Ambassador - Mundo Tango"
        description="Represent Mundo Tango in your city. Get free Pro membership, exclusive badges, and help connect the global tango community."
      />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            <div className="glass-card rounded-2xl p-8 md:p-12 space-y-6">
              ...
              >
                Represent Mundo Tango in your city. Help visiting dancers discover your local scene 
                and connect the global tango community.
              </motion.p>
          ...
          >
            <div className="text-center max-w-3xl mx-auto space-y-4">
              ...
              <motion.p variants={fadeInUp} className="text-lg text-muted-foreground">
                Be recognized for your contribution to the tango community.
              </motion.p>
            </div>
          ...
          >
            <Card className="p-8">
              <CardHeader className="text-center pb-6">
                <CardTitle className="text-2xl">Ambassador Requirements</CardTitle>
                <CardDescription>
                  What it takes to represent Mundo Tango in your city
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            >
              <div className="text-center max-w-3xl mx-auto space-y-4">
                ...
                <motion.p variants={fadeInUp} className="text-muted-foreground">
                  {ambassadors.length} ambassadors representing cities worldwide
                </motion.p>
              </div>
        ...
        <section className="py-16 bg-muted/30" data-testid="section-seeking">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="text-center max-w-3xl mx-auto space-y-4">
                <motion.h2 variants={fadeInUp} className="text-3xl font-bold">
                  Cities Looking for Ambassadors
                </motion.h2>
                <motion.p variants={fadeInUp} className="text-muted-foreground">
                  These cities have active dancers but no ambassador yet. Could it be you?
                </motion.p>
              </div>
                ...
                {citiesSeeking.slice(0, 20).map((city, index) => (
                  <motion.div key={index} variants={fadeInUp}>
                    ...
                    >
                      ...
                      <span className="ml-2 text-muted-foreground">({city.userCount} dancers)</span>
                    </Badge>
                  </motion.div>
                ))}
              </div>
