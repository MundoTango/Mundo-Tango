...
const demoCategories: DemoCategory[] = [
  ...
  },
  {
    id: "guides",
    title: "City Guides",
    description: "Comprehensive guides to tango scenes worldwide. Find the best milongas, schools, and communities across cities globally.",
    icon: BookOpen,
    color: "from-amber-500 to-orange-500",
    features: ["Global city coverage", "Local recommendations", "Community reviews", "Updated regularly"],
    image: "/demos/tango-map.png",
    route: "/city-guides"
  }
];
