                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="bg-white/10 rounded-lg px-4 py-2 inline-block">
                      <span className="text-lg font-bold text-amber-200">
                        {t('pages:landing.hero.nextSession', { 
                          date: nextSessionLabel,
                          defaultValue: `Next Session: ${nextSessionLabel}`
                        })}
                      </span>
                    </div>
                  </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  {t('pages:landing.hero.scottStory', {
                    ...
                    defaultValue: `Scott started dancing tango in ${publicStats?.platformStats?.startedDancing || "September 2007"} and has traveled to ${publicStats?.platformStats?.cities || 79} cities across ${publicStats?.platformStats?.countries || 27} countries for tango. In April 2024, he began building Mundo Tango, investing over ${publicStats?.platformStats?.hoursInvested?.toLocaleString() || "3,000"} hours and $${(publicStats?.platformStats?.amountInvested || 30000).toLocaleString()} of his own money to create the platform the tango community deserves.`
                  })}
                </p>
              </div>
