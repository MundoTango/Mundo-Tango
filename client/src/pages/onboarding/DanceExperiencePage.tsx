...
import { Users, Loader2, ChevronRight, ChevronLeft, Sparkles } from "lucide-react";
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-8 space-y-10">
                    <div className="space-y-4">
                      <Label htmlFor="years" className="text-lg font-medium">Years of Tango Dancing</Label>
