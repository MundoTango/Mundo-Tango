...
export const userLocationHistory = pgTable(
  ...
  (table) => ({
    ...
    currentIdx: index("user_location_history_current_idx").on(
      table.userId,
      table.isCurrent,
    ),
    dateRangeIdx: index("user_location_history_date_range_idx").on(
      table.startDate,
      table.endDate,
    ),
  }),
...
export const insertUserLocationHistorySchema = createInsertSchema(
  userLocationHistory,
).omit({
  id: true,
  createdAt: true,
...
export type InsertUserLocationHistory = z.infer<
  typeof insertUserLocationHistorySchema
>;
...
export const godLevelQuotas = pgTable(
  "god_level_quotas",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    resetDateIdx: index("god_level_quotas_reset_date_idx").on(
      table.quotaResetDate,
    ),
  }),
);
...
export const lumaVideos = pgTable(
  "luma_videos",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    generationIdIdx: index("luma_videos_generation_id_idx").on(
      table.generationId,
    ),
  }),
);
...
export const voiceClones = pgTable(
  "voice_clones",
  {
    ...
    language: varchar("language", { length: 10 }).default("en"),
    modelId: varchar("model_id", { length: 100 }).default(
  ...
  (table) => ({
    ...
    userDefaultIdx: index("voice_clones_user_default_idx").on(
      table.userId,
      table.isDefault,
    ),
...
export const didVideos = pgTable(
  "did_videos",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const profileViews = pgTable(
  ...
  (table) => ({
    profileUserIdx: index("profile_views_profile_user_idx").on(
      table.profileUserId,
    ),
    viewerUserIdx: index("profile_views_viewer_user_idx").on(
      table.viewerUserId,
    ),
    createdAtIdx: index("profile_views_created_at_idx").on(table.createdAt),
    profileTypeIdx: index("profile_views_profile_type_idx").on(
      table.profileType,
    ),
    compositeIdx: index("profile_views_composite_idx").on(
      table.profileUserId,
      table.createdAt,
    ),
  }),
...
export const userSkills = pgTable(
  ...
  (table) => ({
    ...
    uniqueUserSkill: uniqueIndex("unique_user_skill").on(
      table.userId,
      table.skillName,
    ),
  }),
...
export const skillEndorsements = pgTable(
  ...
  (table) => ({
    ...
    uniqueEndorsement: uniqueIndex("unique_skill_endorsement").on(
      table.skillId,
      table.endorserId,
    ),
  }),
...
export const blockedUsers = pgTable(
  ...
  (table) => ({
    ...
    uniqueBlock: uniqueIndex("unique_block").on(
      table.blockerId,
      table.blockedId,
    ),
  }),
...
export const reportedProfiles = pgTable(
  "reported_profiles",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    ...
    reportedIdx: index("reported_profiles_reported_idx").on(
...
export const events = pgTable(
  ...
  (table) => ({
    ...
    cityCountryIdx: index("events_city_country_idx").on(
      table.city,
      table.country,
    ),
    userStartDateIdx: index("events_user_start_date_idx").on(
      table.userId,
      table.startDate,
    ),
...
export const eventRsvps = pgTable(
  ...
  (table) => ({
    ...
    checkedInByIdx: index("event_rsvps_checked_in_by_idx").on(
      table.checkedInBy,
    ),
    paymentStatusIdx: index("event_rsvps_payment_status_idx").on(
      table.paymentStatus,
    ),
    eventStatusIdx: index("event_rsvps_event_status_idx").on(
      table.eventId,
      table.status,
    ),
    userStatusIdx: index("event_rsvps_user_status_idx").on(
      table.userId,
      table.status,
    ),
...
export const eventInvitations = pgTable(
  ...
  (table) => ({
    ...
    uniqueInvite: uniqueIndex("unique_event_invite").on(
      table.eventId,
      table.inviteeId,
    ),
  }),
...
export const groups = pgTable(
  ...
  (table) => ({
    ...
    cityCountryVisibleIdx: index("groups_city_country_visible_idx").on(
      table.city,
      table.country,
      table.visibility,
    ),
...
export const groupMembers = pgTable(
  "group_members",
  {
    ...
    // Notifications
    notificationLevel: varchar("notification_level", { length: 20 }).default(
      "all",
    ),
  ...
  (table) => ({
    ...
    groupRoleIdx: index("group_members_group_role_idx").on(
      table.groupId,
      table.role,
    ),
...
export const groupPosts = pgTable(
  ...
  (table) => ({
    ...
    linkedEventIdx: index("group_posts_linked_event_idx").on(
      table.linkedEventId,
    ),
    ...
    groupCreatedIdx: index("group_posts_group_created_idx").on(
      table.groupId,
      table.createdAt,
    ),
    authorCreatedIdx: index("group_posts_author_created_idx").on(
      table.authorId,
      table.createdAt,
    ),
    groupStatusIdx: index("group_posts_group_status_idx").on(
      table.groupId,
      table.status,
    ),
  }),
...
export const groupCategoryAssignments = pgTable(
  "group_category_assignments",
  {
    groupId: integer("group_id")
      .notNull()
      .references(() => groups.id, { onDelete: "cascade" }),
...
// ============================================================================
// WORKSPACES (Mr Blue vibe coding multi-workspace support)
// ============================================================================
...
export const posts = pgTable(
  ...
  (table) => ({
    ...
    typeExpiresIdx: index("posts_type_expires_idx").on(
      table.type,
      table.expiresAt,
    ),
    ...
    userVisibleIdx: index("posts_user_visible_idx").on(
      table.userId,
      table.visibility,
    ),
    visibleCreatedIdx: index("posts_visible_created_idx").on(
      table.visibility,
      table.createdAt,
    ),
  }),
...
export const placeRecommendations = pgTable(
  "place_recommendations",
  {
    ...
    userIds: text("user_ids")
      .array()
      .default(sql`ARRAY[]::text[]`), // Track who recommended
  ...
  (table) => ({
    ...
    coordsIdx: index("place_recommendations_coords_idx").on(
      table.latitude,
      table.longitude,
    ),
    countIdx: index("place_recommendations_count_idx").on(
      table.recommendationCount,
    ),
    uniquePlace: unique().on(table.latitude, table.longitude, table.category),
  }),
);

export const insertPlaceRecommendationSchema = createInsertSchema(
  placeRecommendations,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertPlaceRecommendation = z.infer<
  typeof insertPlaceRecommendationSchema
>;
export type SelectPlaceRecommendation =
  typeof placeRecommendations.$inferSelect;
...
export const chatRoomUsers = pgTable(
  ...
  (table) => ({
    ...
    uniqueParticipant: uniqueIndex("unique_chat_participant").on(
      table.chatRoomId,
      table.userId,
    ),
  }),
...
export const mrBlueConversations = pgTable(
...
export const mrBlueMessages = pgTable(
  "mr_blue_messages",
  {
    id: serial("id").primaryKey(),
    conversationId: integer("conversation_id")
      .notNull()
      .references(() => mrBlueConversations.id, { onDelete: "cascade" }),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    conversationIdx: index("mr_blue_messages_conversation_idx").on(
      table.conversationId,
    ),
    conversationCreatedIdx: index("mr_blue_messages_conv_created_idx").on(
      table.conversationId,
      table.createdAt,
    ),
...
export const userWorkflowActions = pgTable(
  "user_workflow_actions",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    userTimestampIdx: index("user_workflow_actions_user_timestamp_idx").on(
      table.userId,
...
export const workflowPatterns = pgTable(
  ...
  (table) => ({
    ...
    userConfidenceIdx: index("workflow_patterns_user_confidence_idx").on(
      table.userId,
...
export const messageReactions = pgTable(
  "message_reactions",
  {
    ...
    messageId: integer("message_id")
      .notNull()
      .references(() => mrBlueMessages.id, { onDelete: "cascade" }),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    ...
    uniqueReaction: uniqueIndex("unique_message_user_emoji").on(
      table.messageId,
      table.userId,
      table.emoji,
    ),
...
export const messageBookmarks = pgTable(
  ...
  (table) => ({
    ...
    uniqueBookmark: uniqueIndex("unique_message_user_bookmark").on(
      table.messageId,
      table.userId,
    ),
  }),
...
export const userMemories = pgTable(
  ...
  (table) => ({
    ...
    userTypeIdx: index("user_memories_user_type_idx").on(
      table.userId,
      table.memoryType,
    ),
...
export const conversationSummaries = pgTable(
  ...
  (table) => ({
    ...
    conversationIdx: index("conversation_summaries_conv_idx").on(
      table.conversationId,
    ),
    timeIdx: index("conversation_summaries_time_idx").on(
      table.startTime,
      table.endTime,
    ),
  }),
...
export const userPreferences = pgTable(
  ...
  (table) => ({
    ...
    userKeyIdx: index("user_preferences_user_key_idx").on(
      table.userId,
      table.preferenceKey,
    ),
    confidenceIdx: index("user_preferences_confidence_idx").on(
      table.confidence,
    ),
    uniqueUserKey: uniqueIndex("unique_user_preference_key").on(
      table.userId,
      table.preferenceKey,
    ),
  }),
...
export const lifeCeoConversations = pgTable(
...
export const lifeCeoChatMessages = pgTable(
  "life_ceo_chat_messages",
  {
    id: serial("id").primaryKey(),
    conversationId: integer("conversation_id")
      .notNull()
      .references(() => lifeCeoConversations.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    conversationIdx: index("life_ceo_messages_conversation_idx").on(
      table.conversationId,
    ),
  }),
);
...
export const browserAutomationRecordings = pgTable(
  "browser_automation_recordings",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    ...
    userStatusIdx: index("browser_automation_user_status_idx").on(
      table.userId,
      table.status,
    ),
  }),
...
export const browserAutomationExecutions = pgTable(
  "browser_automation_executions",
  {
    id: serial("id").primaryKey(),
    recordingId: integer("recording_id")
      .notNull()
      .references(() => browserAutomationRecordings.id, {
        onDelete: "cascade",
      }),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    recordingIdx: index("browser_executions_recording_idx").on(
      table.recordingId,
    ),
...
// Life CEO Goals
export const lifeCeoGoals = pgTable(
  "life_ceo_goals",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const lifeCeoTasks = pgTable(
  "life_ceo_tasks",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    goalId: integer("goal_id").references(() => lifeCeoGoals.id, {
      onDelete: "cascade",
    }),
    domainId: integer("domain_id").references(() => lifeCeoDomains.id),
    title: text("title").notNull(),
...
export const lifeCeoMilestones = pgTable(
  "life_ceo_milestones",
  {
    id: serial("id").primaryKey(),
    goalId: integer("goal_id")
      .notNull()
      .references(() => lifeCeoGoals.id, { onDelete: "cascade" }),
    title: text("title").notNull(),
...
export const lifeCeoRecommendations = pgTable(
  "life_ceo_recommendations",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
...
export const h2acMessages = pgTable(
  "h2ac_messages",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    senderIdx: index("h2ac_messages_sender_idx").on(
      table.senderType,
      table.senderId,
    ),
    recipientIdx: index("h2ac_messages_recipient_idx").on(
      table.recipientType,
      table.recipientId,
    ),
...
// Event Invitations
export const insertEventInvitationSchema = createInsertSchema(
  eventInvitations,
).omit({
  id: true,
  createdAt: true,
...
export const insertMrBlueConversationSchema = createInsertSchema(
  mrBlueConversations,
).omit({
  id: true,
  createdAt: true,
...
export type InsertMrBlueConversation = z.infer<
  typeof insertMrBlueConversationSchema
>;
export type SelectMrBlueConversation = typeof mrBlueConversations.$inferSelect;

// Mr Blue Messages
export const insertMrBlueMessageSchema = createInsertSchema(
  mrBlueMessages,
).omit({
  id: true,
  createdAt: true,
...
>;
export type SelectConversationSummary =
...
export const insertLifeCeoConversationSchema = createInsertSchema(
...
export type InsertLifeCeoConversation = z.infer<
  typeof insertLifeCeoConversationSchema
>;
export type SelectLifeCeoConversation =
  typeof lifeCeoConversations.$inferSelect;

// Life CEO Messages
export const insertLifeCeoChatMessageSchema = createInsertSchema(
  lifeCeoChatMessages,
).omit({
  id: true,
  createdAt: true,
});
export type InsertLifeCeoChatMessage = z.infer<
  typeof insertLifeCeoChatMessageSchema
>;
...
export const friendRequests = pgTable(
  ...
  (table) => ({
    ...
    danceEventIdx: index("friend_requests_dance_event_idx").on(
      table.danceEventId,
    ),
    createdAtIdx: index("friend_requests_created_at_idx").on(table.createdAt),
    senderStatusIdx: index("friend_requests_sender_status_idx").on(
      table.senderId,
      table.status,
    ),
    receiverStatusIdx: index("friend_requests_receiver_status_idx").on(
      table.receiverId,
      table.status,
    ),
    uniqueRequest: uniqueIndex("unique_friend_request").on(
      table.senderId,
      table.receiverId,
    ),
  }),
...
export const workshopEnrollments = pgTable(
  ...
  (table) => ({
    workshopIdx: index("workshop_enrollments_workshop_idx").on(
      table.workshopId,
    ),
    userIdx: index("workshop_enrollments_user_idx").on(table.userId),
    unique: index("workshop_enrollments_unique_idx").on(
      table.workshopId,
      table.userId,
    ),
  }),
...
export const storyViews = pgTable(
  ...
  (table) => ({
    ...
    uniqueView: uniqueIndex("unique_story_view").on(
      table.storyId,
      table.viewerId,
    ),
  }),
...
export const liveStreamMessages = pgTable(
  ...
  (table) => ({
    ...
    createdAtIdx: index("live_stream_messages_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
...
export const blockedContent = pgTable(
  ...
  (table) => ({
    ...
    contentIdx: index("blocked_content_content_idx").on(
      table.contentType,
      table.contentId,
    ),
  }),
...
export const insertSkillEndorsementSchema = createInsertSchema(
  skillEndorsements,
).omit({ id: true, createdAt: true });
export type InsertSkillEndorsement = z.infer<
  typeof insertSkillEndorsementSchema
>;
export type SelectSkillEndorsement = typeof skillEndorsements.$inferSelect;

export const insertReportedProfileSchema = createInsertSchema(
  reportedProfiles,
...
export const insertWorkshopEnrollmentSchema = createInsertSchema(
  workshopEnrollments,
).omit({ id: true, enrolledAt: true });
export type InsertWorkshopEnrollment = z.infer<
  typeof insertWorkshopEnrollmentSchema
>;
export type SelectWorkshopEnrollment = typeof workshopEnrollments.$inferSelect;

export const insertMusicSchema = createInsertSchema(musicLibrary).omit({
  id: true,
  createdAt: true,
});
...
export const insertMusicFavoriteSchema = createInsertSchema(
  musicFavorites,
).omit({ id: true, createdAt: true });
...
// Two Factor Secrets
export const insertTwoFactorSecretSchema = createInsertSchema(
  twoFactorSecrets,
).omit({
  id: true,
  createdAt: true,
...
export const communityMembers = pgTable(
  ...
  (table) => ({
    ...
    uniqueMember: uniqueIndex("unique_community_member").on(
      table.communityId,
      table.userId,
    ),
  }),
...
export const clarifierSessions = pgTable(
  "clarifier_sessions",
  {
    id: serial("id").primaryKey(),
    volunteerId: integer("volunteer_id")
  ...
  (table) => ({
    volunteerIdx: index("clarifier_sessions_volunteer_idx").on(
      table.volunteerId,
    ),
  }),
);
...
export const insertClarifierSessionSchema = createInsertSchema(
  clarifierSessions,
).omit({ id: true, createdAt: true, completedAt: true });
export type InsertClarifierSession = z.infer<
  typeof insertClarifierSessionSchema
>;
...
export const friendshipActivities = pgTable(
  ...
  (table) => ({
    friendshipIdx: index("friendship_activities_friendship_idx").on(
      table.friendshipId,
    ),
...
export const friendshipMedia = pgTable(
  "friendship_media",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    ...
    friendshipIdx: index("friendship_media_friendship_idx").on(
      table.friendshipId,
    ),
...
export const postShares = pgTable(
  ...
  (table) => ({
    ...
    uniqueShare: uniqueIndex("unique_post_share").on(
      table.postId,
      table.userId,
      table.shareType,
    ),
...
export const reactions = pgTable(
  ...
  (table) => ({
    ...
    uniqueReaction: uniqueIndex("unique_post_reaction").on(
      table.postId,
      table.userId,
    ),
  }),
...
export const insertFriendshipActivitySchema = createInsertSchema(
  friendshipActivities,
).omit({ id: true, createdAt: true });
export type InsertFriendshipActivity = z.infer<
  typeof insertFriendshipActivitySchema
>;
export type SelectFriendshipActivity = typeof friendshipActivities.$inferSelect;

export const insertFriendshipMediaSchema = createInsertSchema(
  friendshipMedia,
).omit({ id: true, createdAt: true });
...
export const facebookImports = pgTable(
  "facebook_imports",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const facebookFriends = pgTable(
  "facebook_friends",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const insertFacebookImportSchema = createInsertSchema(
  facebookImports,
).omit({ id: true, importDate: true, completedAt: true });
...
export const insertFacebookFriendSchema = createInsertSchema(
  facebookFriends,
...
export const facebookPhotos = pgTable(
  "facebook_photos",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const facebookGroups = pgTable(
  "facebook_groups",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const facebookCheckIns = pgTable(
  "facebook_checkins",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const facebookProfiles = pgTable(
  "facebook_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const facebookVideos = pgTable(
  "facebook_videos",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const insertFacebookEventSchema = createInsertSchema(
  facebookEvents,
).omit({ id: true, importedAt: true });
...
export const insertFacebookPhotoSchema = createInsertSchema(
  facebookPhotos,
).omit({ id: true, importedAt: true });
...
export const insertFacebookGroupSchema = createInsertSchema(
  facebookGroups,
).omit({ id: true, importedAt: true });
...
export const insertFacebookCheckInSchema = createInsertSchema(
  facebookCheckIns,
).omit({ id: true, importedAt: true });
...
export const insertFacebookProfileSchema = createInsertSchema(
  facebookProfiles,
).omit({ id: true, importedAt: true, lastSyncedAt: true });
...
export const insertFacebookVideoSchema = createInsertSchema(
  facebookVideos,
).omit({ id: true, importedAt: true });
...
// Life CEO System
export const insertLifeCeoDomainSchema = createInsertSchema(
  lifeCeoDomains,
).omit({ id: true, createdAt: true });
...
export const insertLifeCeoGoalSchema = createInsertSchema(lifeCeoGoals).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  completedAt: true,
...
export const insertLifeCeoTaskSchema = createInsertSchema(lifeCeoTasks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  completedAt: true,
...
export const insertLifeCeoMilestoneSchema = createInsertSchema(
  lifeCeoMilestones,
).omit({ id: true, createdAt: true, achievedAt: true });
export type InsertLifeCeoMilestone = z.infer<
  typeof insertLifeCeoMilestoneSchema
>;
export type SelectLifeCeoMilestone = typeof lifeCeoMilestones.$inferSelect;

export const insertLifeCeoRecommendationSchema = createInsertSchema(
  lifeCeoRecommendations,
).omit({ id: true, createdAt: true, dismissedAt: true, completedAt: true });
export type InsertLifeCeoRecommendation = z.infer<
  typeof insertLifeCeoRecommendationSchema
>;
export type SelectLifeCeoRecommendation =
  typeof lifeCeoRecommendations.$inferSelect;

// H2AC Framework
export const insertH2acMessageSchema = createInsertSchema(h2acMessages).omit({
  id: true,
  createdAt: true,
  readAt: true,
  respondedAt: true,
...
export const validationChecks = pgTable(
  "validation_checks",
  {
    id: serial("id").primaryKey(),
...
export const userPatterns = pgTable(
  ...
  (table) => ({
    ...
    uniquePattern: uniqueIndex("unique_user_pattern").on(
      table.userId,
      table.fromPage,
      table.toPage,
    ),
...
export const predictionCache = pgTable(
  ...
  (table) => ({
    ...
    currentPageIdx: index("prediction_cache_current_page_idx").on(
      table.currentPage,
    ),
    expiresAtIdx: index("prediction_cache_expires_at_idx").on(table.expiresAt),
    uniquePrediction: uniqueIndex("unique_prediction").on(
      table.userId,
      table.currentPage,
    ),
  }),
...
export const postBookmarks = pgTable(
  ...
  (table) => ({
    ...
    collectionIdx: index("post_bookmarks_collection_idx").on(
      table.collectionName,
    ),
    uniqueBookmark: uniqueIndex("unique_post_bookmark").on(
      table.userId,
      table.postId,
    ),
  }),
...
export const postShareAnalytics = pgTable(
  "post_share_analytics",
  {
    id: serial("id").primaryKey(),
    postId: integer("post_id")
      .notNull()
  ...
  (table) => ({
    ...
    createdAtIdx: index("post_share_analytics_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
...
export const commentLikes = pgTable(
  ...
  (table) => ({
    ...
    uniqueLike: uniqueIndex("unique_comment_like").on(
      table.commentId,
      table.userId,
    ),
  }),
...
export const userInteractions = pgTable(
  ...
  (table) => ({
    ...
    targetIdx: index("user_interactions_target_idx").on(
      table.targetType,
      table.targetId,
    ),
...
// Housing Listings
export const housingListings = pgTable(
  "housing_listings",
  {
    id: serial("id").primaryKey(),
...
// Housing Bookings
export const housingBookings = pgTable(
  "housing_bookings",
  {
    id: serial("id").primaryKey(),
    listingId: integer("listing_id")
      .notNull()
      .references(() => housingListings.id, { onDelete: "cascade" }),
...
// Housing Favorites
export const housingFavorites = pgTable(
  "housing_favorites",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    unique: index("housing_favorites_unique_idx").on(
      table.userId,
      table.listingId,
    ),
  }),
...
export const albumMedia = pgTable(
  ...
  (table) => ({
    ...
    uniqueAlbumMedia: uniqueIndex("unique_album_media").on(
      table.albumId,
      table.mediaId,
    ),
  }),
...
export const tutorialModules = pgTable(
  "tutorial_modules",
  {
    id: serial("id").primaryKey(),
...
export const insertValidationCheckSchema = createInsertSchema(
  validationChecks,
).omit({ id: true, createdAt: true });
...
export const insertPredictionCacheSchema = createInsertSchema(
  predictionCache,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// Post Actions
export const insertPostEditSchema = createInsertSchema(postEdits).omit({
  id: true,
  createdAt: true,
});
...
export const insertPostShareAnalyticsSchema = createInsertSchema(
  postShareAnalytics,
).omit({ id: true, createdAt: true });
export type InsertPostShareAnalytics = z.infer<
  typeof insertPostShareAnalyticsSchema
>;
...
export const insertUserInteractionSchema = createInsertSchema(
  userInteractions,
).omit({ id: true, createdAt: true });
...
// Housing & Marketplace
export const insertHousingListingSchema = createInsertSchema(
  housingListings,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertHousingBookingSchema = createInsertSchema(
  housingBookings,
).omit({ id: true, createdAt: true });
...
export const insertAlbumMediaSchema = createInsertSchema(albumMedia).omit({
  id: true,
  addedAt: true,
});
...
export const insertTutorialModuleSchema = createInsertSchema(
  tutorialModules,
).omit({ id: true, createdAt: true });
...
export const platformUserRoles = pgTable(
  ...
  (table) => ({
    ...
    uniqueUserRole: uniqueIndex("unique_platform_user_role").on(
      table.userId,
      table.roleId,
    ),
  }),
...
export const platformRolePermissions = pgTable(
  ...
  (table) => ({
    ...
    idxPermission: index("idx_platform_role_permissions_permission").on(
      table.permissionId,
    ),
    uniqueRolePermission: uniqueIndex("unique_platform_role_permission").on(
      table.roleId,
      table.permissionId,
    ),
  }),
...
export const tierLimits = pgTable(
  ...
  (table) => ({
    ...
    uniqueTierFeature: uniqueIndex("unique_tier_feature").on(
      table.tierName,
      table.featureFlagId,
    ),
  }),
...
export const userFeatureUsage = pgTable(
  "user_feature_usage",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    uniqueUserFeature: uniqueIndex("unique_user_feature").on(
      table.userId,
      table.featureFlagId,
    ),
  }),
...
export const tierFeatures = pgTable(
  ...
  (table) => ({
    ...
    uniqueTierFeature: uniqueIndex("unique_tier_feature_key").on(
      table.tierId,
      table.featureKey,
    ),
  }),
...
export const upgradeEvents = pgTable(
  ...
  (table) => ({
    ...
    idxConversion: index("idx_upgrade_events_conversion").on(
      table.conversionCompleted,
    ),
...
export const checkoutSessions = pgTable(
  ...
  (table) => ({
    ...
    idxStripeSession: index("idx_checkout_sessions_stripe").on(
...
export const recommendations = pgTable(
  ...
  (table) => ({
    ...
    targetIdx: index("recommendations_target_idx").on(
      table.targetType,
      table.targetId,
    ),
...
export const roleInvitations = pgTable(
  "role_invitations",
  {
    id: serial("id").primaryKey(),
    inviterId: integer("inviter_id")
...
export const favorites = pgTable(
  ...
  (table) => ({
    ...
    targetIdx: index("favorites_target_idx").on(
      table.targetType,
      table.targetId,
    ),
...
export const communityStats = pgTable(
  ...
  (table) => ({
    ...
    uniqueCityCountry: uniqueIndex("unique_city_country").on(
      table.city,
      table.country,
    ),
  }),
...
export const insertPlatformPermissionSchema = createInsertSchema(
  platformPermissions,
).omit({ id: true, createdAt: true });
export type InsertPlatformPermission = z.infer<
  typeof insertPlatformPermissionSchema
>;
export type SelectPlatformPermission = typeof platformPermissions.$inferSelect;

export const insertPlatformUserRoleSchema = createInsertSchema(
  platformUserRoles,
).omit({ id: true, assignedAt: true, createdAt: true });
export type InsertPlatformUserRole = z.infer<
  typeof insertPlatformUserRoleSchema
>;
export type SelectPlatformUserRole = typeof platformUserRoles.$inferSelect;

export const insertPlatformRolePermissionSchema = createInsertSchema(
  platformRolePermissions,
).omit({ id: true, createdAt: true });
export type InsertPlatformRolePermission = z.infer<
  typeof insertPlatformRolePermissionSchema
>;
export type SelectPlatformRolePermission =
  typeof platformRolePermissions.$inferSelect;
...
export const insertUserFeatureUsageSchema = createInsertSchema(
  userFeatureUsage,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertUserFeatureUsage = z.infer<
  typeof insertUserFeatureUsageSchema
>;
...
export const insertPricingExperimentSchema = createInsertSchema(
  pricingExperiments,
).omit({ id: true, createdAt: true });
export type InsertPricingExperiment = z.infer<
  typeof insertPricingExperimentSchema
>;
export type SelectPricingExperiment = typeof pricingExperiments.$inferSelect;

// Conversion Tracking (Phase 2)
export const insertUpgradeEventSchema = createInsertSchema(upgradeEvents).omit({
  id: true,
  createdAt: true,
});
...
export const failedActions = pgTable(
  "failed_actions",
  {
    id: serial("id").primaryKey(),
...
export const visualEdits = pgTable(
  "visual_edits",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    deployedIdx: index("idx_visual_edits_deployed").on(
      table.deployedToProduction,
    ),
  }),
);
...
export const agentKnowledge = pgTable(
  "agent_knowledge",
  {
    ...
    content: text("content").notNull(),
    confidence: real("confidence"),
    sourceMemoryId: integer("source_memory_id").references(
      () => agentMemories.id,
    ),
    tags: text("tags").array(),
    createdAt: timestamp("created_at").notNull().defaultNow(),
...
export const agentCollaborations = pgTable(
  ...
  (table) => ({
    requestingIdx: index("idx_agent_collab_requesting").on(
      table.requestingAgent,
    ),
    respondingIdx: index("idx_agent_collab_responding").on(
      table.respondingAgent,
    ),
...
export const agentSelfTests = pgTable(
  "agent_self_tests",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 }).notNull(),
...
export const agentPerformanceMetrics = pgTable(
  ...
  (table) => ({
    ...
    timeWindowIdx: index("idx_perf_time_window").on(
      table.timeWindow,
      table.windowStart,
    ),
...
export const agentPerformanceAlerts = pgTable(
...
export const agentChangeBroadcasts = pgTable(
  "agent_change_broadcasts",
  {
    id: serial("id").primaryKey(),
    ...
    // Affected Agents
    affectedAgents: text("affected_agents")
      .array()
      .default(sql`ARRAY[]::text[]`), // List of agent IDs that need to know
    ...
    // Broadcasting
    broadcastStrategy: varchar("broadcast_strategy", { length: 50 }).default(
      "immediate",
    ...
    acknowledgedBy: text("acknowledged_by")
      .array()
      .default(sql`ARRAY[]::text[]`), // List of agent IDs that acknowledged
  ...
  (table) => ({
    ...
    nextRetryIdx: index("idx_change_broadcasts_next_retry").on(
      table.nextRetryAt,
    ),
    affectedAgentsIdx: index("idx_change_broadcasts_affected_agents").using(
      "gin",
      table.affectedAgents,
    ),
    sourceAgentIdx: index("idx_change_broadcasts_source_agent").on(
      table.sourceAgent,
    ),
  }),
);
...
export const agentDecisions = pgTable(
  "agent_decisions",
  {
    ...
    // Voting & Consensus
    votingMechanism: varchar("voting_mechanism", { length: 50 }).default(
      "majority",
    ), // 'unanimous' | 'majority' | 'weighted' | 'authority'
    ...
    conflictResolutionStrategy: varchar("conflict_resolution_strategy", {
      length: 50,
    }), // 'vote' | 'priority' | 'authority' | 'human_escalation'
  ...
  (table) => ({
    decisionIdIdx: index("idx_agent_decisions_decision_id").on(
      table.decisionId,
    ),
    ...
    participatingAgentsIdx: index("idx_agent_decisions_participants").using(
      "gin",
      table.participatingAgents,
    ),
    initiatedByIdx: index("idx_agent_decisions_initiated_by").on(
      table.initiatedBy,
    ),
  }),
);
...
export const intelligenceCycles = pgTable(
  "intelligence_cycles",
  {
    id: serial("id").primaryKey(),
    ...
    stepsCompleted: text("steps_completed")
      .array()
      .default(sql`ARRAY[]::text[]`), // List of completed steps
    stepsOrder: text("steps_order")
      .array()
      .default(
        sql`ARRAY['LEARN', 'TEST', 'ANALYZE', 'COLLABORATE', 'BUILD', 'TEST', 'REPORT']::text[]`,
      ),
    ...
    participatingAgents: text("participating_agents")
      .array()
      .default(sql`ARRAY[]::text[]`), // All agents involved
  ...
  (table) => ({
    ...
    currentStepIdx: index("idx_intelligence_cycles_current_step").on(
      table.currentStep,
    ),
    cycleTypeIdx: index("idx_intelligence_cycles_type").on(table.cycleType),
    leadAgentIdx: index("idx_intelligence_cycles_lead_agent").on(
      table.leadAgent,
    ),
    createdAtIdx: index("idx_intelligence_cycles_created_at").on(
      table.createdAt,
    ),
    nextScheduledIdx: index("idx_intelligence_cycles_next_scheduled").on(
      table.nextScheduledRun,
    ),
    participatingAgentsIdx: index("idx_intelligence_cycles_participants").using(
      "gin",
      table.participatingAgents,
    ),
  }),
...
export const professionalExperiences = pgTable(
...
// Role Invitations
export const insertRoleInvitationSchema = createInsertSchema(
  roleInvitations,
...
// Community Stats
export const insertCommunityStatsSchema = createInsertSchema(
  communityStats,
...
// Agent Self Tests
export const insertAgentSelfTestSchema = createInsertSchema(
  agentSelfTests,
).omit({ id: true, createdAt: true });
...
export type InsertAgentPerformanceMetrics = z.infer<
  typeof insertAgentPerformanceMetricsSchema
>;
export type SelectAgentPerformanceMetrics =
  typeof agentPerformanceMetrics.$inferSelect;

// Agent Performance Alerts
export const insertAgentPerformanceAlertsSchema = createInsertSchema(
...
export type InsertAgentPerformanceAlert = z.infer<
  typeof insertAgentPerformanceAlertsSchema
>;
export type SelectAgentPerformanceAlert =
  typeof agentPerformanceAlerts.$inferSelect;
...
export const contentReports = pgTable(
  ...
  (table) => ({
    ...
    contentIdx: index("idx_content_reports_content").on(
      table.contentType,
      table.contentId,
    ),
  }),
...
export const userReports = pgTable(
  ...
  (table) => ({
    ...
    reportedUserIdx: index("idx_user_reports_reported_user").on(
      table.reportedUserId,
    ),
...
export const moderationQueue = pgTable(
  ...
  (table) => ({
    contentTypeIdx: index("idx_moderation_queue_content_type").on(
      table.contentType,
    ),
    ...
    compositeIdx: index("idx_moderation_queue_composite").on(
      table.status,
      table.priority,
      table.createdAt,
    ),
    userIdx: index("idx_moderation_queue_user").on(table.userId),
    autoFlaggedIdx: index("idx_moderation_queue_auto_flagged").on(
      table.autoFlagged,
    ),
  }),
);
...
export const moderationActions = pgTable(
  ...
  (table) => ({
    ...
    actionTypeIdx: index("idx_moderation_actions_action_type").on(
      table.actionType,
    ),
    targetTypeIdx: index("idx_moderation_actions_target_type").on(
      table.targetType,
    ),
...
export const roleRequests = pgTable(
  ...
  (table) => ({
    ...
    requestedRoleIdx: index("idx_role_requests_requested_role").on(
      table.requestedRole,
    ),
...
export const banAppealslogs = pgTable(
  "ban_appeals",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
      .notNull(),
    suspensionLogId: integer("suspension_log_id").references(
      () => suspensionLogs.id,
    ),
...
export const travelPlanItems = pgTable(
  "travel_plan_items",
  {
    id: serial("id").primaryKey(),
...
export const tripJoinRequests = pgTable(
  ...
  (table) => ({
    ...
    requesterIdx: index("idx_trip_join_requests_requester").on(
      table.requesterId,
    ),
    ...
    uniqueRequest: uniqueIndex("idx_trip_join_unique").on(
      table.tripId,
      table.requesterId,
    ),
  }),
...
export const insertTripJoinRequestSchema = createInsertSchema(
  tripJoinRequests,
).omit({
  id: true,
  createdAt: true,
...
export const talentMatches = pgTable(
  "talent_matches",
  {
    id: serial("id").primaryKey(),
...
export const teacherProfiles = pgTable(
  "teacher_profiles",
  {
    ...
    certificationDetails: jsonb("certification_details").$type<
      Array<{
        name: string;
        issuer: string;
        year: number;
    ...
    hourlyRate: numeric("hourly_rate", { precision: 10, scale: 2 }),
    currency: varchar("currency", { length: 3 }).default("USD"),
    privateClassRate: numeric("private_class_rate", {
      precision: 10,
      scale: 2,
    }),
...
// 2. DJ Profiles
export const djProfiles = pgTable(
  "dj_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const photographerProfiles = pgTable(
  ...
  (table) => ({
    ...
    ratingIdx: index("photographer_profiles_rating_idx").on(
      table.averageRating,
    ),
  }),
);
...
export const performerProfiles = pgTable(
  "performer_profiles",
  {
    ...
    notablePerformances: jsonb("notable_performances").$type<
      Array<{
        event: string;
        venue: string;
        date: string;
...
// 6. Musician Profiles
export const musicianProfiles = pgTable(
  "musician_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const choreographerProfiles = pgTable(
  "choreographer_profiles",
  {
    ...
    // Works Created
    worksCreated: jsonb("works_created").$type<
      Array<{
        title: string;
        year: number;
        duration: string;
  ...
  (table) => ({
    ...
    ratingIdx: index("choreographer_profiles_rating_idx").on(
      table.averageRating,
    ),
  }),
);
...
export const tangoSchoolProfiles = pgTable(
  "tango_school_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
    ...
    // Instructors
    instructors: jsonb("instructors").$type<
      Array<{
        name: string;
        bio?: string;
        photo?: string;
  ...
  (table) => ({
    ...
    ratingIdx: index("tango_school_profiles_rating_idx").on(
      table.averageRating,
    ),
  }),
);
...
export const tangoHotelProfiles = pgTable(
  "tango_hotel_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
    ...
    eventsHosted: jsonb("events_hosted").$type<
      Array<{
        name: string;
        frequency: string;
        description?: string;
    ...
    tangoPackages: jsonb("tango_packages").$type<
      Array<{
        name: string;
        description: string;
        price: number;
...
export const wellnessProfiles = pgTable(
  "wellness_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const tourOperatorProfiles = pgTable(
  ...
  (table) => ({
    ...
    ratingIdx: index("tour_operator_profiles_rating_idx").on(
      table.averageRating,
    ),
  }),
);
...
export const hostVenueProfiles = pgTable(
  "host_venue_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
    ...
    externalCateringAllowed: boolean("external_catering_allowed").default(
      false,
    ),
...
export const tangoGuideProfiles = pgTable(
  "tango_guide_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
...
export const contentCreatorProfiles = pgTable(
  "content_creator_profiles",
  {
    ...
    // Portfolio
    portfolioUrl: text("portfolio_url"),
    featuredWork: jsonb("featured_work").$type<
      Array<{
        title: string;
        url: string;
        type: string;
    ...
    // Pricing
    collaborationRates: jsonb("collaboration_rates").$type<
      Array<{
        type: string;
        price: number;
        description: string;
  ...
  (table) => ({
    ...
    followersIdx: index("content_creator_profiles_followers_idx").on(
      table.totalFollowers,
    ),
    ratingIdx: index("content_creator_profiles_rating_idx").on(
      table.averageRating,
    ),
  }),
);
...
export const learningResourceProfiles = pgTable(
  "learning_resource_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
  ...
  (table) => ({
    ...
    activeIdx: index("learning_resource_profiles_active_idx").on(
      table.isActive,
    ),
    ratingIdx: index("learning_resource_profiles_rating_idx").on(
      table.averageRating,
    ),
    studentsIdx: index("learning_resource_profiles_students_idx").on(
      table.totalStudents,
    ),
  }),
);
...
export const taxiDancerProfiles = pgTable(
  "taxi_dancer_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .references(() => users.id, { onDelete: "cascade" })
...
export const organizerProfiles = pgTable(
  "organizer_profiles",
  {
    ...
    pastEvents: jsonb("past_events").$type<
      Array<{
        name: string;
        type: string;
        date: string;
...
export const newsletterCampaigns = pgTable(
  ...
  (table) => ({
    ...
    scheduledIdx: index("idx_newsletter_campaigns_scheduled").on(
      table.scheduledAt,
    ),
  }),
);
...
export const newsletterSends = pgTable(
  ...
  (table) => ({
    ...
    subscriberIdx: index("idx_newsletter_sends_subscriber").on(
      table.subscriberId,
    ),
...
export const featureReviewStatus = pgTable(
...
export const safetyReviews = pgTable(
  ...
  (table) => ({
    targetIdx: index("idx_safety_reviews_target").on(
      table.targetType,
      table.targetId,
    ),
...
export const insertProfessionalExperienceSchema = createInsertSchema(
  professionalExperiences,
).omit({ id: true, createdAt: true, updatedAt: true, verifiedAt: true });
export type InsertProfessionalExperience = z.infer<
  typeof insertProfessionalExperienceSchema
>;
export type SelectProfessionalExperience =
  typeof professionalExperiences.$inferSelect;
...
export const insertUserAchievementSchema = createInsertSchema(
  userAchievements,
).omit({ id: true, createdAt: true, earnedAt: true });
...
// Flagged Content
export const insertFlaggedContentSchema = createInsertSchema(
  flaggedContent,
).omit({ id: true, createdAt: true });
...
// Suspension Logs
export const insertSuspensionLogSchema = createInsertSchema(
  suspensionLogs,
).omit({ id: true, createdAt: true });
...
// Ban Appeals
export const insertBanAppealSchema = createInsertSchema(banAppealslogs).omit({
  id: true,
  createdAt: true,
  reviewedAt: true,
});
...
// Travel Plan Items
export const insertTravelPlanItemSchema = createInsertSchema(
  travelPlanItems,
).omit({ id: true, createdAt: true });
...
// Talent Profiles
export const insertTalentProfileSchema = createInsertSchema(
  talentProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// Talent Matches
export const insertTalentMatchSchema = createInsertSchema(talentMatches).omit({
  id: true,
  createdAt: true,
});
...
// 1. Teacher Profiles
export const insertTeacherProfileSchema = createInsertSchema(
  teacherProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// 2. DJ Profiles
export const insertDJProfileSchema = createInsertSchema(djProfiles).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
// 3. Photographer Profiles
export const insertPhotographerProfileSchema = createInsertSchema(
  photographerProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertPhotographerProfile = z.infer<
  typeof insertPhotographerProfileSchema
>;
export type SelectPhotographerProfile =
  typeof photographerProfiles.$inferSelect;

// 4. Performer Profiles
export const insertPerformerProfileSchema = createInsertSchema(
  performerProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertPerformerProfile = z.infer<
  typeof insertPerformerProfileSchema
>;
...
// 6. Musician Profiles
export const insertMusicianProfileSchema = createInsertSchema(
  musicianProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// 7. Choreographer Profiles
export const insertChoreographerProfileSchema = createInsertSchema(
  choreographerProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertChoreographerProfile = z.infer<
  typeof insertChoreographerProfileSchema
>;
export type SelectChoreographerProfile =
  typeof choreographerProfiles.$inferSelect;

// 8. Tango School Profiles
export const insertTangoSchoolProfileSchema = createInsertSchema(
  tangoSchoolProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertTangoSchoolProfile = z.infer<
  typeof insertTangoSchoolProfileSchema
>;
export type SelectTangoSchoolProfile = typeof tangoSchoolProfiles.$inferSelect;

// 9. Tango Hotel Profiles
export const insertTangoHotelProfileSchema = createInsertSchema(
  tangoHotelProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertTangoHotelProfile = z.infer<
  typeof insertTangoHotelProfileSchema
>;
export type SelectTangoHotelProfile = typeof tangoHotelProfiles.$inferSelect;

// 10. Wellness Profiles
export const insertWellnessProfileSchema = createInsertSchema(
  wellnessProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// 11. Tour Operator Profiles
export const insertTourOperatorProfileSchema = createInsertSchema(
  tourOperatorProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertTourOperatorProfile = z.infer<
  typeof insertTourOperatorProfileSchema
>;
export type SelectTourOperatorProfile =
  typeof tourOperatorProfiles.$inferSelect;

// 12. Host Venue Profiles
export const insertHostVenueProfileSchema = createInsertSchema(
  hostVenueProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertHostVenueProfile = z.infer<
  typeof insertHostVenueProfileSchema
>;
export type SelectHostVenueProfile = typeof hostVenueProfiles.$inferSelect;

// 13. Tango Guide Profiles
export const insertTangoGuideProfileSchema = createInsertSchema(
  tangoGuideProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertTangoGuideProfile = z.infer<
  typeof insertTangoGuideProfileSchema
>;
export type SelectTangoGuideProfile = typeof tangoGuideProfiles.$inferSelect;

// 14. Content Creator Profiles
export const insertContentCreatorProfileSchema = createInsertSchema(
  contentCreatorProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertContentCreatorProfile = z.infer<
  typeof insertContentCreatorProfileSchema
>;
export type SelectContentCreatorProfile =
  typeof contentCreatorProfiles.$inferSelect;

// 15. Learning Resource Profiles
export const insertLearningResourceProfileSchema = createInsertSchema(
  learningResourceProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertLearningResourceProfile = z.infer<
  typeof insertLearningResourceProfileSchema
>;
export type SelectLearningResourceProfile =
  typeof learningResourceProfiles.$inferSelect;

// 16. Taxi Dancer Profiles
export const insertTaxiDancerProfileSchema = createInsertSchema(
  taxiDancerProfiles,
).omit({
  id: true,
  createdAt: true,
...
export type InsertTaxiDancerProfile = z.infer<
  typeof insertTaxiDancerProfileSchema
>;
...
export const updateTeacherProfileSchema = insertTeacherProfileSchema
  .partial()
  .extend({
...
export const updatePhotographerProfileSchema = insertPhotographerProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
...
export type UpdatePhotographerProfile = z.infer<
  typeof updatePhotographerProfileSchema
>;

// 4. Performer Profile Update Schema
export const updatePerformerProfileSchema = insertPerformerProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
...
export type UpdatePerformerProfile = z.infer<
  typeof updatePerformerProfileSchema
>;

// 5. Vendor Profile Update Schema
export const updateVendorProfileSchema = insertVendorProfileSchema
  .partial()
  .extend({
...
export const updateMusicianProfileSchema = insertMusicianProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
...
export const updateChoreographerProfileSchema = insertChoreographerProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
    yearsExperience: z.number().int().min(0).max(100).optional(),
...
export type UpdateChoreographerProfile = z.infer<
  typeof updateChoreographerProfileSchema
>;

// 8. Tango School Profile Update Schema
export const updateTangoSchoolProfileSchema = insertTangoSchoolProfileSchema
  .partial()
  .extend({
...
export type UpdateTangoSchoolProfile = z.infer<
  typeof updateTangoSchoolProfileSchema
>;

// 9. Tango Hotel Profile Update Schema
export const updateTangoHotelProfileSchema = insertTangoHotelProfileSchema
  .partial()
  .extend({
...
export type UpdateTangoHotelProfile = z.infer<
  typeof updateTangoHotelProfileSchema
>;

// 10. Wellness Profile Update Schema
export const updateWellnessProfileSchema = insertWellnessProfileSchema
  .partial()
  .extend({
    businessName: z.string().max(255),
    bio: z.string().max(5000).optional(),
...
export const updateTourOperatorProfileSchema = insertTourOperatorProfileSchema
  .partial()
  .extend({
...
export type UpdateTourOperatorProfile = z.infer<
  typeof updateTourOperatorProfileSchema
>;

// 12. Host Venue Profile Update Schema
export const updateHostVenueProfileSchema = insertHostVenueProfileSchema
  .partial()
  .extend({
...
export type UpdateHostVenueProfile = z.infer<
  typeof updateHostVenueProfileSchema
>;

// 13. Tango Guide Profile Update Schema
export const updateTangoGuideProfileSchema = insertTangoGuideProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
    yearsExperience: z.number().int().min(0).max(100).optional(),
...
export type UpdateTangoGuideProfile = z.infer<
  typeof updateTangoGuideProfileSchema
>;

// 14. Content Creator Profile Update Schema
export const updateContentCreatorProfileSchema =
  insertContentCreatorProfileSchema.partial().extend({
    bio: z.string().max(5000).optional(),
...
export type UpdateContentCreatorProfile = z.infer<
  typeof updateContentCreatorProfileSchema
>;

// 15. Learning Resource Profile Update Schema
export const updateLearningResourceProfileSchema =
  insertLearningResourceProfileSchema.partial().extend({
...
export type UpdateLearningResourceProfile = z.infer<
  typeof updateLearningResourceProfileSchema
>;

// 16. Taxi Dancer Profile Update Schema
export const updateTaxiDancerProfileSchema = insertTaxiDancerProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
    yearsExperience: z.number().int().min(0).max(100).optional(),
...
export type UpdateTaxiDancerProfile = z.infer<
  typeof updateTaxiDancerProfileSchema
>;

// 17. Organizer Profile Update Schema
export const updateOrganizerProfileSchema = insertOrganizerProfileSchema
  .partial()
  .extend({
    bio: z.string().max(5000).optional(),
...
export type UpdateOrganizerProfile = z.infer<
...
export const insertFeatureReviewStatusSchema = createInsertSchema(
  featureReviewStatus,
).omit({ id: true, submittedAt: true, reviewedAt: true, approvedAt: true });
export type InsertFeatureReviewStatus = z.infer<
  typeof insertFeatureReviewStatusSchema
>;
export type SelectFeatureReviewStatus = typeof featureReviewStatus.$inferSelect;

// Safety Reviews
export const insertSafetyReviewSchema = createInsertSchema(safetyReviews).omit({
  id: true,
  createdAt: true,
  reviewedAt: true,
  resolvedAt: true,
...
export const insertNewsletterCampaignSchema = createInsertSchema(
  newsletterCampaigns,
).omit({ id: true, createdAt: true, sentAt: true });
export type InsertNewsletterCampaign = z.infer<
  typeof insertNewsletterCampaignSchema
>;
export type SelectNewsletterCampaign = typeof newsletterCampaigns.$inferSelect;

// Newsletter Sends
export const insertNewsletterSendSchema = createInsertSchema(
  newsletterSends,
...
export const insertVenueRecommendationSchema = createInsertSchema(
  venueRecommendations,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertVenueRecommendation = z.infer<
  typeof insertVenueRecommendationSchema
>;
export type SelectVenueRecommendation =
  typeof venueRecommendations.$inferSelect;
...
export const learningPatterns = pgTable(
  ...
  (table) => ({
    patternNameIdx: index("learning_patterns_pattern_name_idx").on(
      table.patternName,
    ),
    categoryIdx: index("learning_patterns_category_idx").on(table.category),
    successRateIdx: index("learning_patterns_success_rate_idx").on(
      table.successRate,
    ),
...
export const validationResults = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    validatorAgent: varchar("validator_agent", { length: 50 }).default(
      "Agent #79",
    ),
  ...
  (table) => ({
    targetAgentIdx: index("validation_results_target_agent_idx").on(
      table.targetAgent,
    ),
...
export const customerJourneyTests = pgTable(
  ...
  (table) => ({
    journeyNameIdx: index("customer_journey_tests_journey_name_idx").on(
      table.journeyName,
    ),
    statusIdx: index("customer_journey_tests_status_idx").on(table.status),
    testedAtIdx: index("customer_journey_tests_tested_at_idx").on(
      table.testedAt,
    ),
  }),
);
...
export const evidencePackages = pgTable(
  ...
  (table) => ({
    ...
    validationIdx: index("evidence_packages_validation_idx").on(
      table.validationPassed,
    ),
    confidenceIdx: index("evidence_packages_confidence_idx").on(
      table.confidence,
    ),
...
export const insertEvidencePackageSchema = createInsertSchema(
  evidencePackages,
).omit({ id: true, createdAt: true });
 ...
 */
export const agentDocumentationIndex = pgTable(
  "agent_documentation_index",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 })
      .notNull()
  ...
  (table) => ({
    ...
    relevanceIdx: index("agent_doc_index_relevance_idx").on(
 ...
 */
export const agentCodeKnowledge = pgTable(
  "agent_code_knowledge",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 })
      .notNull()
    ...
    understandingLevel: varchar("understanding_level", { length: 20 }).default(
      "none",
  ...
  (table) => ({
    ...
    understandingIdx: index("agent_code_knowledge_understanding_idx").on(
      table.understandingLevel,
    ),
  }),
);
 ...
 */
export const agentSMETraining = pgTable(
  "agent_sme_training",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 })
  ...
  (table) => ({
    ...
    proficiencyIdx: index("agent_sme_training_proficiency_idx").on(
 ...
 */
export const agentIndustryStandards = pgTable(
  "agent_industry_standards",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 })
      .notNull()
    ...
    practicalApplicationCount: integer("practical_application_count").default(
      0,
    ),
  ...
  (table) => ({
    ...
    standardTypeIdx: index("agent_industry_standards_type_idx").on(
      table.standardType,
    ),
    proficiencyIdx: index("agent_industry_standards_proficiency_idx").on(
 ...
 */
export const pageAgentRegistry = pgTable(
  "page_agent_registry",
  {
    ...
    pageAgentId: varchar("page_agent_id", { length: 100 })
      .notNull()
  ...
  (table) => ({
    ...
    pageAgentIdx: index("page_agent_registry_page_agent_idx").on(
      table.pageAgentId,
    ),
    lastAuditIdx: index("page_agent_registry_last_audit_idx").on(
      table.lastAudit,
    ),
  }),
);

export const insertPageAgentRegistrySchema = createInsertSchema(
  pageAgentRegistry,
).omit({ createdAt: true, updatedAt: true });
export type InsertPageAgentRegistry = z.infer<
  typeof insertPageAgentRegistrySchema
>;
...
export const pageAudits = pgTable(
  "page_audits",
  {
    ...
    pageId: varchar("page_id", { length: 100 })
      .notNull()
      .references(() => pageAgentRegistry.pageId),
 ...
 */
export const pageHealingLogs = pgTable(
  "page_healing_logs",
  {
    id: serial("id").primaryKey(),
    pageId: varchar("page_id", { length: 100 })
    ...
    postHealAuditId: integer("post_heal_audit_id").references(
      () => pageAudits.id,
    ), // Audit after healing
  ...
  (table) => ({
    ...
    timestampIdx: index("page_healing_logs_timestamp_idx").on(
      table.healingTimestamp,
    ),
    successIdx: index("page_healing_logs_success_idx").on(table.success),
  }),
);

export const insertPageHealingLogSchema = createInsertSchema(
  pageHealingLogs,
).omit({ id: true, healingTimestamp: true });
 ...
 */
export const pagePreChecks = pgTable(
  "page_pre_checks",
  {
    id: serial("id").primaryKey(),
    pageId: varchar("page_id", { length: 100 })
    ...
    // Proactive healing
    proactiveHealingApplied: boolean("proactive_healing_applied").default(
      false,
    ),
    healingLogId: integer("healing_log_id").references(
      () => pageHealingLogs.id,
    ),
  ...
  (table) => ({
    ...
    sourcePageIdx: index("page_pre_checks_source_page_idx").on(
      table.sourcePageId,
    ),
    expiresAtIdx: index("page_pre_checks_expires_at_idx").on(table.expiresAt),
    confidenceIdx: index("page_pre_checks_confidence_idx").on(
      table.confidenceScore,
    ),
  }),
);

export const insertPagePreCheckSchema = createInsertSchema(pagePreChecks).omit({
  id: true,
...
export const agentBeliefs = pgTable(
  ...
  (table) => ({
    uniqueAgentPage: index("agent_beliefs_unique_idx").on(
      table.agentId,
      table.pageId,
    ),
...
export const insertAgentBeliefsSchema = createInsertSchema(agentBeliefs).omit({
  id: true,
  createdAt: true,
  lastUpdated: true,
});
 ...
 */
export const predictionErrors = pgTable(
  "prediction_errors",
  {
    id: serial("id").primaryKey(),
    pageId: varchar("page_id", { length: 100 })
  ...
  (table) => ({
    ...
    surpriseIdx: index("prediction_errors_surprise_idx").on(
      table.surpriseScore,
    ),
...
export const insertPredictionErrorSchema = createInsertSchema(
  predictionErrors,
 ...
 */
export const aiGuardrailViolations = pgTable(
  ...
  (table) => ({
    guardrailLayerIdx: index("ai_guardrail_violations_layer_idx").on(
      table.guardrailLayer,
    ),
    violationTypeIdx: index("ai_guardrail_violations_type_idx").on(
      table.violationType,
    ),
    severityIdx: index("ai_guardrail_violations_severity_idx").on(
      table.severity,
    ),
    ...
    detectedAtIdx: index("ai_guardrail_violations_detected_at_idx").on(
      table.detectedAt,
    ),
    impactIdx: index("ai_guardrail_violations_impact_idx").on(
      table.impactLevel,
      table.severity,
    ),
  }),
...
// Agent Learnings
export const insertAgentLearningSchema = createInsertSchema(
  agentLearnings,
).omit({ id: true, createdAt: true });
...
// Agent Escalations
export const insertAgentEscalationSchema = createInsertSchema(
  agentEscalations,
...
// Learning Patterns
export const insertLearningPatternSchema = createInsertSchema(
  learningPatterns,
...
export const insertAgentCollaborationSchema = createInsertSchema(
  agentCollaborations,
).omit({ id: true, requestedAt: true, resolvedAt: true });
export type InsertAgentCollaboration = z.infer<
  typeof insertAgentCollaborationSchema
>;
...
export const insertAgentDocumentationIndexSchema = createInsertSchema(
  agentDocumentationIndex,
).omit({ id: true, createdAt: true });
export type InsertAgentDocumentationIndex = z.infer<
  typeof insertAgentDocumentationIndexSchema
>;
export type SelectAgentDocumentationIndex =
  typeof agentDocumentationIndex.$inferSelect;

// Agent Code Knowledge (MB.MD v9.0 - SME Training)
export const insertAgentCodeKnowledgeSchema = createInsertSchema(
  agentCodeKnowledge,
).omit({ id: true, createdAt: true });
export type InsertAgentCodeKnowledge = z.infer<
  typeof insertAgentCodeKnowledgeSchema
>;
export type SelectAgentCodeKnowledge = typeof agentCodeKnowledge.$inferSelect;

// Agent SME Training (MB.MD v9.0 - SME Training)
export const insertAgentSMETrainingSchema = createInsertSchema(
  agentSMETraining,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertAgentSMETraining = z.infer<
  typeof insertAgentSMETrainingSchema
>;
export type SelectAgentSMETraining = typeof agentSMETraining.$inferSelect;

// Agent Industry Standards (MB.MD v9.0 - SME Training)
export const insertAgentIndustryStandardsSchema = createInsertSchema(
  agentIndustryStandards,
).omit({ id: true, createdAt: true });
export type InsertAgentIndustryStandards = z.infer<
  typeof insertAgentIndustryStandardsSchema
>;
export type SelectAgentIndustryStandards =
  typeof agentIndustryStandards.$inferSelect;
...
export const insertCustomerJourneyTestSchema = createInsertSchema(
  customerJourneyTests,
).omit({ id: true, createdAt: true, testedAt: true });
export type InsertCustomerJourneyTest = z.infer<
  typeof insertCustomerJourneyTestSchema
>;
export type SelectCustomerJourneyTest =
  typeof customerJourneyTests.$inferSelect;

// AI Guardrail Violations (APPENDIX Q - BATCH 28)
export const insertAIGuardrailViolationSchema = createInsertSchema(
...
export type InsertAIGuardrailViolation = z.infer<
  typeof insertAIGuardrailViolationSchema
>;
export type SelectAIGuardrailViolation =
  typeof aiGuardrailViolations.$inferSelect;

// Agent Change Broadcasts (TRACK 2 BATCH 10-12)
export const insertAgentChangeBroadcastSchema = createInsertSchema(
  agentChangeBroadcasts,
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export type InsertAgentChangeBroadcast = z.infer<
  typeof insertAgentChangeBroadcastSchema
>;
export type SelectAgentChangeBroadcast =
  typeof agentChangeBroadcasts.$inferSelect;

// Agent Decisions (TRACK 2 BATCH 10-12)
export const insertAgentDecisionSchema = createInsertSchema(
  agentDecisions,
).omit({
  id: true,
  createdAt: true,
...
export const insertIntelligenceCycleSchema = createInsertSchema(
  intelligenceCycles,
).omit({
  id: true,
  createdAt: true,
...
export type InsertIntelligenceCycle = z.infer<
  typeof insertIntelligenceCycleSchema
>;
...
export const aiRequests = pgTable(
  ...
  (table) => ({
    ...
    conversationIdx: index("ai_requests_conversation_idx").on(
      table.conversationId,
    ),
    ...
    platformModelIdx: index("ai_requests_platform_model_idx").on(
      table.platform,
      table.model,
    ),
    ...
    userCostIdx: index("ai_requests_user_cost_idx").on(
      table.userId,
      table.totalCost,
      table.createdAt,
    ),
    platformCostIdx: index("ai_requests_platform_cost_idx").on(
      table.platform,
      table.totalCost,
      table.createdAt,
    ),
...
export const aiCosts = pgTable(
  ...
  (table) => ({
    ...
    platformModelDateIdx: index("ai_costs_platform_model_date_idx").on(
      table.platform,
      table.model,
      table.date,
    ),
    uniqueCostEntry: uniqueIndex("unique_cost_entry").on(
      table.date,
      table.platform,
      table.model,
      table.hour,
...
export const aiCache = pgTable(
  "ai_cache",
  {
    ...
    totalSavings: numeric("total_savings", { precision: 10, scale: 6 }).default(
      "0",
  ...
  (table) => ({
    ...
    platformModelIdx: index("ai_cache_platform_model_idx").on(
      table.platform,
      table.model,
    ),
...
export const aiRateLimits = pgTable(
  ...
  (table) => ({
    platformModelIdx: uniqueIndex("ai_rate_limits_platform_model_idx").on(
      table.platform,
      table.model,
    ),
 ...
 */
export const aiCircuitBreakers = pgTable(
  "ai_circuit_breakers",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    platformModelIdx: uniqueIndex("ai_circuit_breakers_platform_model_idx").on(
      table.platform,
      table.model,
    ),
    stateIdx: index("ai_circuit_breakers_state_idx").on(table.state),
    nextAttemptIdx: index("ai_circuit_breakers_next_attempt_idx").on(
      table.nextAttemptAt,
    ),
  }),
);
 ...
 */
export const aiBlackboard = pgTable(
  "ai_blackboard",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    ...
    sessionTaskIdx: index("ai_blackboard_session_task_idx").on(
      table.sessionId,
      table.taskType,
    ),
  }),
 ...
 */
export const aiPerformance = pgTable(
  "ai_performance",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    platformModelIdx: index("ai_performance_platform_model_idx").on(
      table.platform,
      table.model,
    ),
    windowStartIdx: index("ai_performance_window_start_idx").on(
      table.windowStart,
    ),
    healthScoreIdx: index("ai_performance_health_score_idx").on(
      table.healthScore,
    ),
    platformWindowIdx: index("ai_performance_platform_window_idx").on(
      table.platform,
      table.windowStart,
    ),
    uniqueWindow: uniqueIndex("unique_performance_window").on(
      table.platform,
      table.model,
      table.windowStart,
    ),
...
// AI Circuit Breakers
export const insertAICircuitBreakerSchema = createInsertSchema(
  aiCircuitBreakers,
).omit({ id: true, updatedAt: true });
export type InsertAICircuitBreaker = z.infer<
  typeof insertAICircuitBreakerSchema
>;
export type SelectAICircuitBreaker = typeof aiCircuitBreakers.$inferSelect;

// AI Blackboard
export const insertAIBlackboardSchema = createInsertSchema(aiBlackboard).omit({
  id: true,
  createdAt: true,
});
...
export const routingDecisions = pgTable(
  ...
  (table) => ({
    ...
    platformModelIdx: index("routing_decisions_platform_model_idx").on(
      table.platform,
      table.modelUsed,
    ),
    ...
    userFeedbackIdx: index("routing_decisions_user_feedback_idx").on(
      table.userFeedback,
    ),
 ...
 */
export const aiSpendTracking = pgTable(
  "ai_spend_tracking",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    platformModelIdx: index("ai_spend_tracking_platform_model_idx").on(
      table.platform,
      table.model,
    ),
    billingMonthIdx: index("ai_spend_tracking_billing_month_idx").on(
      table.billingMonth,
    ),
    userBillingIdx: index("ai_spend_tracking_user_billing_idx").on(
      table.userId,
      table.billingMonth,
    ),
...
export const costBudgets = pgTable(
  "cost_budgets",
  {
    ...
    alertThreshold: numeric("alert_threshold", {
      precision: 5,
      scale: 2,
    }).notNull(), // Percentage 0.00-100.00

    // Per-request limits (optional)
    maxCostPerRequest: numeric("max_cost_per_request", {
      precision: 10,
      scale: 6,
    }),
...
export const insertRoutingDecisionSchema = createInsertSchema(
  routingDecisions,
).omit({ id: true, createdAt: true });
...
export const insertAISpendTrackingSchema = createInsertSchema(
  aiSpendTracking,
).omit({ id: true, timestamp: true });
...
export const budgetAlerts = pgTable(
  "budget_alerts",
  {
    ...
    percentageUsed: numeric("percentage_used", {
      precision: 5,
      scale: 2,
    }).notNull(),
  ...
  (table) => ({
    ...
    billingMonthIdx: index("budget_alerts_billing_month_idx").on(
      table.billingMonth,
    ),
    userBillingIdx: index("budget_alerts_user_billing_idx").on(
      table.userId,
      table.billingMonth,
    ),
 ...
 */
export const dpoTrainingData = pgTable(
  "dpo_training_data",
  {
    id: serial("id").primaryKey(),
    query: text("query").notNull(),
    ...
    rejectedCost: numeric("rejected_cost", {
      precision: 10,
      scale: 6,
    }).notNull(),
...
export const curriculumLevels = pgTable(
  "curriculum_levels",
  {
    ...
    successRate: numeric("success_rate", { precision: 5, scale: 4 }).default(
      "0",
    ), // 0-1 score
  ...
  (table) => ({
    ...
    successRateIdx: index("curriculum_levels_success_rate_idx").on(
      table.successRate,
    ),
  }),
);
 ...
 */
export const gepaExperiments = pgTable(
  "gepa_experiments",
  {
    id: serial("id").primaryKey(),
    name: varchar("name", { length: 255 }).notNull(),
...
export const insertDpoTrainingDataSchema = createInsertSchema(
  dpoTrainingData,
).omit({ id: true, createdAt: true });
...
export const insertCurriculumLevelSchema = createInsertSchema(
  curriculumLevels,
).omit({ id: true, updatedAt: true });
...
export const insertGepaExperimentSchema = createInsertSchema(
  gepaExperiments,
...
export const insertGoldenExampleSchema = createInsertSchema(
  goldenExamples,
).omit({ id: true, createdAt: true });
...
export const agentExecutions = pgTable(
  "agent_executions",
  {
    ...
    feedbackComment: text("feedback_comment"),
    userRating: integer("user_rating"), // 1-5 stars
    performanceVsBaseline: numeric("performance_vs_baseline", {
      precision: 6,
      scale: 4,
    }), // -1 to 1 (worse to better)
 ...
 */
export const agentKnowledgeVersions = pgTable(
  "agent_knowledge_versions",
  {
    ...
    performanceImprovement: numeric("performance_improvement", {
      precision: 6,
      scale: 4,
    }), // % improvement
    ...
    averageEfficiency: numeric("average_efficiency", {
      precision: 5,
      scale: 4,
    }),
  ...
  (table) => ({
    agentVersionIdx: uniqueIndex(
      "agent_knowledge_versions_agent_version_idx",
    ).on(table.agentId, table.version),
    agentIdx: index("agent_knowledge_versions_agent_idx").on(table.agentId),
    isActiveIdx: index("agent_knowledge_versions_active_idx").on(
      table.isActive,
    ),
    performanceIdx: index("agent_knowledge_versions_performance_idx").on(
      table.performanceImprovement,
    ),
    createdAtIdx: index("agent_knowledge_versions_created_at_idx").on(
      table.createdAt,
    ),
    testStatusIdx: index("agent_knowledge_versions_test_status_idx").on(
      table.testStatus,
    ),
  }),
);
...
export const insertAgentKnowledgeVersionSchema = createInsertSchema(
  agentKnowledgeVersions,
).omit({ id: true, createdAt: true });
export type InsertAgentKnowledgeVersion = z.infer<
  typeof insertAgentKnowledgeVersionSchema
>;
export type SelectAgentKnowledgeVersion =
  typeof agentKnowledgeVersions.$inferSelect;
...
export const preFlightChecks = pgTable(
  ...
  (table) => ({
    ...
    allChecksIdx: index("pre_flight_checks_all_checks_idx").on(
      table.allChecksPassed,
    ),
  }),
);
 ...
 */
export const globalAgentLessons = pgTable(
  "global_agent_lessons",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    ...
    confidenceIdx: index("global_agent_lessons_confidence_idx").on(
      table.confidence,
    ),
    successRateIdx: index("global_agent_lessons_success_rate_idx").on(
      table.successRate,
    ),
    createdAtIdx: index("global_agent_lessons_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
 ...
 */
export const predictedIssues = pgTable(
  "predicted_issues",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    sourceIssueIdx: index("predicted_issues_source_issue_idx").on(
      table.sourceIssueId,
    ),
    predictionTypeIdx: index("predicted_issues_type_idx").on(
      table.predictionType,
    ),
    confidenceIdx: index("predicted_issues_confidence_idx").on(
      table.confidence,
    ),
    actuallyOccurredIdx: index("predicted_issues_occurred_idx").on(
      table.actuallyOccurred,
    ),
  }),
);
 ...
 */
export const agentCoordinationSessions = pgTable(
  ...
  (table) => ({
    sessionIdIdx: uniqueIndex("agent_coordination_sessions_session_id_idx").on(
      table.sessionId,
    ),
    pageIdIdx: index("agent_coordination_sessions_page_id_idx").on(
      table.pageId,
    ),
    leadAgentIdx: index("agent_coordination_sessions_lead_agent_idx").on(
      table.leadAgentId,
    ),
    consensusIdx: index("agent_coordination_sessions_consensus_idx").on(
      table.consensusReached,
    ),
  }),
);

// Advanced Self-Healing Zod Schemas & Types
export const insertPreFlightCheckSchema = createInsertSchema(
  preFlightChecks,
).omit({ id: true, timestamp: true });
...
export const insertGlobalAgentLessonSchema = createInsertSchema(
  globalAgentLessons,
).omit({ id: true, createdAt: true });
export type InsertGlobalAgentLesson = z.infer<
  typeof insertGlobalAgentLessonSchema
>;
export type SelectGlobalAgentLesson = typeof globalAgentLessons.$inferSelect;

export const insertPredictedIssueSchema = createInsertSchema(
  predictedIssues,
).omit({ id: true, createdAt: true });
...
export const insertAgentCoordinationSessionSchema = createInsertSchema(
  agentCoordinationSessions,
).omit({ id: true, createdAt: true });
export type InsertAgentCoordinationSession = z.infer<
  typeof insertAgentCoordinationSessionSchema
>;
export type SelectAgentCoordinationSession =
  typeof agentCoordinationSessions.$inferSelect;
...
export const profileMedia = pgTable(
  ...
  (table) => ({
    ...
    orderIdx: index("profile_media_order_idx").on(
      table.userId,
      table.displayOrder,
    ),
    featuredIdx: index("profile_media_featured_idx").on(
      table.userId,
      table.isFeatured,
    ),
  }),
...
export const profileAnalytics = pgTable(
  ...
  (table) => ({
    profileUserIdx: index("profile_analytics_profile_user_idx").on(
      table.profileUserId,
    ),
    viewerUserIdx: index("profile_analytics_viewer_user_idx").on(
      table.viewerUserId,
    ),
    viewDateIdx: index("profile_analytics_view_date_idx").on(table.viewDate),
    uniqueViewIdx: index("profile_analytics_unique_view_idx").on(
      table.isUniqueView,
    ),
    interactionIdx: index("profile_analytics_interaction_idx").on(
      table.interactionType,
    ),
    profileDateIdx: index("profile_analytics_profile_date_idx").on(
      table.profileUserId,
      table.viewDate,
    ),
  }),
...
export const profileInquiries = pgTable(
  "profile_inquiries",
  {
    ...
    // Inquirer
    inquirerUserId: integer("inquirer_user_id").references(() => users.id, {
      onDelete: "set null",
    }),
  ...
  (table) => ({
    profileUserIdx: index("profile_inquiries_profile_user_idx").on(
      table.profileUserId,
    ),
    inquirerUserIdx: index("profile_inquiries_inquirer_user_idx").on(
      table.inquirerUserId,
    ),
 ...
 */
export const travelPreferencesProfiles = pgTable(
  "travel_preferences_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
 ...
 */
export const eventsProfiles = pgTable(
  "events_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    attendanceIdx: index("events_profiles_attendance_idx").on(
      table.totalEventsAttended,
    ),
  }),
);
 ...
 */
export const friendsNetworkProfiles = pgTable(
  "friends_network_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    ...
    friendsIdx: index("friends_network_profiles_friends_idx").on(
      table.totalFriends,
    ),
  }),
);
 ...
 */
export const photosMediaGalleryProfiles = pgTable(
  "photos_media_gallery_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
    ...
    // Privacy Settings
    defaultPhotoVisibility: varchar("default_photo_visibility", {
      length: 20,
    }).default("public"),
  ...
  (table) => ({
    ...
    photosIdx: index("photos_media_gallery_profiles_photos_idx").on(
      table.totalPhotos,
    ),
  }),
);
 ...
 */
export const aboutBioExtendedProfiles = pgTable(
  "about_bio_extended_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
 ...
 */
export const feedActivityProfiles = pgTable(
  "feed_activity_profiles",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
    ...
    // Activity Patterns
    averagePostsPerWeek: numeric("average_posts_per_week", {
      precision: 5,
      scale: 2,
    }),
    ...
    defaultPostVisibility: varchar("default_post_visibility", {
      length: 20,
    }).default("public"),
  ...
  (table) => ({
    ...
    engagementIdx: index("feed_activity_profiles_engagement_idx").on(
      table.totalLikesReceived,
    ),
  }),
);
...
export const insertProfileAnalyticsSchema = createInsertSchema(
  profileAnalytics,
).omit({ id: true });
export type InsertProfileAnalytics = z.infer<
  typeof insertProfileAnalyticsSchema
>;
export type SelectProfileAnalytics = typeof profileAnalytics.$inferSelect;

// Profile Inquiries Zod Schemas
export const insertProfileInquirySchema = createInsertSchema(
  profileInquiries,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertTravelPreferencesProfileSchema = createInsertSchema(
  travelPreferencesProfiles,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const updateTravelPreferencesProfileSchema =
  insertTravelPreferencesProfileSchema.partial();
export type InsertTravelPreferencesProfile = z.infer<
  typeof insertTravelPreferencesProfileSchema
>;
export type UpdateTravelPreferencesProfile = z.infer<
  typeof updateTravelPreferencesProfileSchema
>;
export type SelectTravelPreferencesProfile =
  typeof travelPreferencesProfiles.$inferSelect;
...
export const insertFriendsNetworkProfileSchema = createInsertSchema(
  friendsNetworkProfiles,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const updateFriendsNetworkProfileSchema =
  insertFriendsNetworkProfileSchema.partial();
export type InsertFriendsNetworkProfile = z.infer<
  typeof insertFriendsNetworkProfileSchema
>;
export type UpdateFriendsNetworkProfile = z.infer<
  typeof updateFriendsNetworkProfileSchema
>;
export type SelectFriendsNetworkProfile =
  typeof friendsNetworkProfiles.$inferSelect;

// 21. Photos/Media Gallery Profile Schema
export const insertPhotosMediaGalleryProfileSchema = createInsertSchema(
  photosMediaGalleryProfiles,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const updatePhotosMediaGalleryProfileSchema =
  insertPhotosMediaGalleryProfileSchema.partial();
export type InsertPhotosMediaGalleryProfile = z.infer<
  typeof insertPhotosMediaGalleryProfileSchema
>;
export type UpdatePhotosMediaGalleryProfile = z.infer<
  typeof updatePhotosMediaGalleryProfileSchema
>;
export type SelectPhotosMediaGalleryProfile =
  typeof photosMediaGalleryProfiles.$inferSelect;

// 22. About/Bio Extended Profile Schema
export const insertAboutBioExtendedProfileSchema = createInsertSchema(
  aboutBioExtendedProfiles,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const updateAboutBioExtendedProfileSchema =
  insertAboutBioExtendedProfileSchema.partial();
export type InsertAboutBioExtendedProfile = z.infer<
  typeof insertAboutBioExtendedProfileSchema
>;
export type UpdateAboutBioExtendedProfile = z.infer<
  typeof updateAboutBioExtendedProfileSchema
>;
export type SelectAboutBioExtendedProfile =
  typeof aboutBioExtendedProfiles.$inferSelect;

// 23. Feed/Activity Profile Schema
export const insertFeedActivityProfileSchema = createInsertSchema(
  feedActivityProfiles,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const updateFeedActivityProfileSchema =
  insertFeedActivityProfileSchema.partial();
export type InsertFeedActivityProfile = z.infer<
  typeof insertFeedActivityProfileSchema
>;
export type UpdateFeedActivityProfile = z.infer<
  typeof updateFeedActivityProfileSchema
>;
export type SelectFeedActivityProfile =
  typeof feedActivityProfiles.$inferSelect;
...
export const financialPortfolios = pgTable(
...
export const financialAccounts = pgTable(
  ...
  (table) => ({
    ...
    accountTypeIdx: index("financial_accounts_account_type_idx").on(
      table.accountType,
    ),
  }),
);
...
export const financialAssets = pgTable(
  "financial_assets",
  {
    ...
    portfolioId: integer("portfolio_id")
      .notNull()
      .references(() => financialPortfolios.id, { onDelete: "cascade" }),
...
export const financialTrades = pgTable(
  "financial_trades",
  {
    id: serial("id").primaryKey(),
    portfolioId: integer("portfolio_id")
  ...
  (table) => ({
    ...
    executedAtIdx: index("financial_trades_executed_at_idx").on(
      table.executedAt,
    ),
  }),
);
...
export const financialStrategies = pgTable(
  "financial_strategies",
  {
    ...
    capitalAllocation: numeric("capital_allocation", {
      precision: 15,
      scale: 2,
    }).notNull(),
  ...
  (table) => ({
    ...
    strategyTypeIdx: index("financial_strategies_strategy_type_idx").on(
      table.strategyType,
    ),
...
export const financialMarketData = pgTable(
  ...
  (table) => ({
    ...
    timestampIdx: index("financial_market_data_timestamp_idx").on(
      table.timestamp,
    ),
    symbolTimestampIdx: index("financial_market_data_symbol_timestamp_idx").on(
      table.symbol,
      table.timestamp,
    ),
  }),
...
export const financialAIDecisions = pgTable(
  "financial_ai_decisions",
  {
    id: serial("id").primaryKey(),
    ...
    executedTradeId: integer("executed_trade_id").references(
      () => financialTrades.id,
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
  },
  (table) => ({
    ...
    portfolioIdx: index("financial_ai_decisions_portfolio_idx").on(
      table.portfolioId,
    ),
    decisionTypeIdx: index("financial_ai_decisions_decision_type_idx").on(
      table.decisionType,
    ),
    createdAtIdx: index("financial_ai_decisions_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
...
export const financialRiskMetrics = pgTable(
  ...
  (table) => ({
    portfolioIdx: index("financial_risk_metrics_portfolio_idx").on(
      table.portfolioId,
    ),
    calculatedAtIdx: index("financial_risk_metrics_calculated_at_idx").on(
      table.calculatedAt,
    ),
  }),
);
...
export const financialAgents = pgTable(
  "financial_agents",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    agentNumberIdx: index("financial_agents_agent_number_idx").on(
      table.agentNumber,
    ),
...
export const financialMonitoring = pgTable(
  "financial_monitoring",
  {
    id: serial("id").primaryKey(),
    agentId: integer("agent_id")
      .notNull()
      .references(() => financialAgents.id, { onDelete: "cascade" }),
    portfolioId: integer("portfolio_id").references(
      () => financialPortfolios.id,
      { onDelete: "cascade" },
    ),
  ...
  (table) => ({
    ...
    portfolioIdx: index("financial_monitoring_portfolio_idx").on(
      table.portfolioId,
    ),
    checkTypeIdx: index("financial_monitoring_check_type_idx").on(
      table.checkType,
    ),
    timestampIdx: index("financial_monitoring_timestamp_idx").on(
      table.timestamp,
    ),
  }),
);
...
export const insertFinancialPortfolioSchema = createInsertSchema(
  financialPortfolios,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const selectFinancialPortfolioSchema =
  createSelectSchema(financialPortfolios);
export type InsertFinancialPortfolio = z.infer<
  typeof insertFinancialPortfolioSchema
>;
...
export const selectFinancialAccountSchema =
...
export const insertFinancialStrategySchema = createInsertSchema(
  financialStrategies,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const selectFinancialStrategySchema =
  createSelectSchema(financialStrategies);
export type InsertFinancialStrategy = z.infer<
  typeof insertFinancialStrategySchema
>;
export type SelectFinancialStrategy = typeof financialStrategies.$inferSelect;

// 6. Financial Market Data
export const insertFinancialMarketDataSchema = createInsertSchema(
  financialMarketData,
)
  .omit({ id: true, timestamp: true })
  .extend({
...
export const selectFinancialMarketDataSchema =
  createSelectSchema(financialMarketData);
export type InsertFinancialMarketData = z.infer<
  typeof insertFinancialMarketDataSchema
>;
export type SelectFinancialMarketData = typeof financialMarketData.$inferSelect;

// 7. Financial AI Decisions
export const insertFinancialAIDecisionSchema = createInsertSchema(
  financialAIDecisions,
)
  .omit({ id: true, createdAt: true })
  .extend({
    agentId: z.number().int().min(73).max(105),
...
export const selectFinancialAIDecisionSchema =
  createSelectSchema(financialAIDecisions);
export type InsertFinancialAIDecision = z.infer<
  typeof insertFinancialAIDecisionSchema
>;
export type SelectFinancialAIDecision =
  typeof financialAIDecisions.$inferSelect;

// 8. Financial Risk Metrics
export const insertFinancialRiskMetricsSchema = createInsertSchema(
...
export const selectFinancialRiskMetricsSchema =
  createSelectSchema(financialRiskMetrics);
export type InsertFinancialRiskMetrics = z.infer<
  typeof insertFinancialRiskMetricsSchema
>;
export type SelectFinancialRiskMetrics =
  typeof financialRiskMetrics.$inferSelect;
...
export const insertFinancialMonitoringSchema = createInsertSchema(
  financialMonitoring,
)
  .omit({ id: true, timestamp: true })
  .extend({
...
export const selectFinancialMonitoringSchema =
  createSelectSchema(financialMonitoring);
export type InsertFinancialMonitoring = z.infer<
  typeof insertFinancialMonitoringSchema
>;
...
export const scrapedEvents = pgTable(
  "scraped_events",
  {
    id: serial("id").primaryKey(),
    ...
    teacherText: text("teacher_text"),
    performerText: text("performer_text"),
    participantProfiles: jsonb("participant_profiles").$type<Array<{name: string; role: string; profileId?: number; userId?: number; confidence: number}>>(),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
  },
  (table) => ({
...
export const platformConnections = pgTable(
  ...
  (table) => ({
    userPlatformIdx: uniqueIndex("platform_connections_user_platform_idx").on(
      table.userId,
      table.platform,
    ),
...
export const aiGeneratedContent = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    campaignId: integer("campaign_id").references(() => socialCampaigns.id, {
      onDelete: "set null",
    }),
...
export const eventClaims = pgTable(
  "event_claims",
  {
    ...
    scrapedEventId: integer("scraped_event_id")
      .notNull()
      .references(() => scrapedEvents.id, { onDelete: "cascade" }),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
...
export const crossPlatformAnalytics = pgTable(
...
export const apiHealthLogs = pgTable(
  "api_health_logs",
  {
    id: serial("id").primaryKey(),
    platform: varchar("platform", { length: 50 }).notNull(),
...
export const insertEventScrapingSourceSchema = createInsertSchema(
...
export const selectEventScrapingSourceSchema =
  createSelectSchema(eventScrapingSources);
export type InsertEventScrapingSource = z.infer<
  typeof insertEventScrapingSourceSchema
>;
export type SelectEventScrapingSource =
  typeof eventScrapingSources.$inferSelect;
...
export const selectPlatformConnectionSchema =
  createSelectSchema(platformConnections);
...
export const selectAIGeneratedContentSchema =
  createSelectSchema(aiGeneratedContent);
...
export const insertCrossPlatformAnalyticsSchema = createInsertSchema(
...
export const selectCrossPlatformAnalyticsSchema = createSelectSchema(
  crossPlatformAnalytics,
);
export type InsertCrossPlatformAnalytics = z.infer<
  typeof insertCrossPlatformAnalyticsSchema
>;
export type SelectCrossPlatformAnalytics =
  typeof crossPlatformAnalytics.$inferSelect;
...
export const fundingCampaigns = pgTable(
  "funding_campaigns",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const campaignDonations = pgTable(
  ...
  (table) => ({
    ...
    donatedAtIdx: index("campaign_donations_donated_at_idx").on(
      table.donatedAt,
    ),
  }),
);
...
export const documentSignatures = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    documentInstanceId: integer("document_instance_id")
      .notNull()
  ...
  (table) => ({
    documentIdx: index("document_signatures_document_idx").on(
      table.documentInstanceId,
    ),
...
export const marketplaceProducts = pgTable(
  ...
  (table) => ({
    creatorIdx: index("marketplace_products_creator_idx").on(
      table.creatorUserId,
    ),
    ...
    createdAtIdx: index("marketplace_products_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
...
export const productPurchases = pgTable(
  "product_purchases",
  {
    ...
    amount: numeric("amount", { precision: 10, scale: 2 }).notNull(),
    platformFee: numeric("platform_fee", { precision: 10, scale: 2 }).notNull(),
    creatorPayout: numeric("creator_payout", {
      precision: 10,
      scale: 2,
    }).notNull(),
...
export const productReviews = pgTable(
  "product_reviews",
  {
    ...
    rating: integer("rating").notNull(),
    review: text("review"),
    isPurchaseVerified: boolean("is_purchase_verified")
      .default(false)
      .notNull(),
  ...
  (table) => ({
    ...
    uniqueReview: uniqueIndex("unique_product_review").on(
      table.productId,
      table.userId,
    ),
  }),
...
export const marketplaceAnalytics = pgTable(
  "marketplace_analytics",
  {
    ...
    platformFees: numeric("platform_fees", {
      precision: 10,
      scale: 2,
    }).notNull(),
  ...
  (table) => ({
    ...
    periodStartIdx: index("marketplace_analytics_period_start_idx").on(
      table.periodStart,
    ),
  }),
);
...
// 2. Campaign Donations
export const insertCampaignDonationSchema = createInsertSchema(
  campaignDonations,
)
...
export const selectCampaignDonationSchema =
  createSelectSchema(campaignDonations);
export type InsertCampaignDonation = z.infer<
  typeof insertCampaignDonationSchema
>;
...
export const insertDocumentInstanceSchema = createInsertSchema(
  documentInstances,
)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
...
export const selectDocumentInstanceSchema =
  createSelectSchema(documentInstances);
export type InsertDocumentInstance = z.infer<
  typeof insertDocumentInstanceSchema
>;
export type SelectDocumentInstance = typeof documentInstances.$inferSelect;

// 6. Document Signatures
export const insertDocumentSignatureSchema = createInsertSchema(
  documentSignatures,
)
...
export const selectDocumentSignatureSchema =
  createSelectSchema(documentSignatures);
export type InsertDocumentSignature = z.infer<
  typeof insertDocumentSignatureSchema
>;
...
export const selectMarketplaceProductSchema =
  createSelectSchema(marketplaceProducts);
...
// 10. Marketplace Analytics
export const insertMarketplaceAnalyticsSchema = createInsertSchema(
...
export const selectMarketplaceAnalyticsSchema =
  createSelectSchema(marketplaceAnalytics);
export type InsertMarketplaceAnalytics = z.infer<
  typeof insertMarketplaceAnalyticsSchema
>;
export type SelectMarketplaceAnalytics =
  typeof marketplaceAnalytics.$inferSelect;
...
export const travelSearches = pgTable(
  "travel_searches",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    searchedAtIdx: index("travel_searches_searched_at_idx").on(
      table.searchedAt,
    ),
...
export const flightResults = pgTable(
  "flight_results",
  {
    ...
    searchId: integer("search_id")
      .notNull()
      .references(() => travelSearches.id, { onDelete: "cascade" }),
...
export const accommodationResults = pgTable(
  ...
  (table) => ({
    ...
    providerIdx: index("accommodation_results_provider_idx").on(
      table.apiProvider,
    ),
...
export const tripPlans = pgTable(
  "trip_plans",
  {
    ...
    budget: numeric("budget", { precision: 10, scale: 2 }),
    actualSpent: numeric("actual_spent", { precision: 10, scale: 2 }).default(
      "0",
    ),
    notes: text("notes"),
    createdAt: timestamp("created_at").defaultNow(),
...
export const tripItineraryItems = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    tripPlanId: integer("trip_plan_id")
      .notNull()
...
export const travelBuddies = pgTable(
  "travel_buddies",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    destinationIdx: index("travel_buddies_destination_idx").on(
      table.destination,
    ),
...
export const travelAlerts = pgTable(
  "travel_alerts",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const travelApiCache = pgTable(
  "travel_api_cache",
  {
    id: serial("id").primaryKey(),
...
export const insertAccommodationResultSchema = createInsertSchema(
...
export const selectAccommodationResultSchema =
  createSelectSchema(accommodationResults);
export type InsertAccommodationResult = z.infer<
  typeof insertAccommodationResultSchema
>;
export type SelectAccommodationResult =
  typeof accommodationResults.$inferSelect;
...
export const insertTripItineraryItemSchema = createInsertSchema(
  tripItineraryItems,
)
  .omit({ id: true })
  .extend({
...
export const selectTripItineraryItemSchema =
  createSelectSchema(tripItineraryItems);
export type InsertTripItineraryItem = z.infer<
  typeof insertTripItineraryItemSchema
>;
export type SelectTripItineraryItem = typeof tripItineraryItems.$inferSelect;

// 7. Travel Preferences
export const insertTravelPreferenceSchema = createInsertSchema(
  travelPreferences,
)
  .omit({ id: true, updatedAt: true })
  .extend({
...
export const selectTravelPreferenceSchema =
  createSelectSchema(travelPreferences);
export type InsertTravelPreference = z.infer<
  typeof insertTravelPreferenceSchema
>;
...
export const legalClauses = pgTable(
  ...
  (table) => ({
    ...
    jurisdictionIdx: index("legal_clauses_jurisdiction_idx").on(
      table.jurisdiction,
    ),
...
export const documentReviews = pgTable(
  "document_reviews",
  {
    ...
    instanceId: integer("instance_id").references(() => documentInstances.id, {
      onDelete: "cascade",
    }),
  ...
  (table) => ({
    ...
    reviewedAtIdx: index("document_reviews_reviewed_at_idx").on(
      table.reviewedAt,
    ),
  }),
);
...
export const legalAgreements = pgTable(
  ...
  (table) => ({
    ...
    effectiveDateIdx: index("legal_agreements_effective_date_idx").on(
      table.effectiveDate,
    ),
    expirationDateIdx: index("legal_agreements_expiration_date_idx").on(
...
export const selectDocumentAuditLogSchema =
  createSelectSchema(documentAuditLogs);
...
export const insertDataExportRequestSchema = createInsertSchema(
  dataExportRequests,
)
...
export const selectDataExportRequestSchema =
  createSelectSchema(dataExportRequests);
export type InsertDataExportRequest = z.infer<
  typeof insertDataExportRequestSchema
>;
...
export const webauthnCredentials = pgTable(
  ...
  (table) => ({
    ...
    credentialIdx: uniqueIndex("webauthn_credentials_credential_idx").on(
      table.credentialId,
    ),
  }),
);

export const insertWebauthnCredentialSchema =
  createInsertSchema(webauthnCredentials);

export const selectWebauthnCredentialSchema =
...
export const anomalyDetections = pgTable(
  ...
  (table) => ({
    ...
    detectedAtIdx: index("anomaly_detections_detected_at_idx").on(
      table.detectedAt,
    ),
  }),
);

export const insertAnomalyDetectionSchema = createInsertSchema(
  anomalyDetections,
).omit({ id: true, detectedAt: true });

export const selectAnomalyDetectionSchema =
  createSelectSchema(anomalyDetections);
export type InsertAnomalyDetection = z.infer<
  typeof insertAnomalyDetectionSchema
>;
...
export const scrapedCommunityData = pgTable(
  "scraped_community_data",
  {
    id: serial("id").primaryKey(),
    sourceId: integer("source_id")
      .references(() => eventScrapingSources.id, { onDelete: "cascade" })
      .notNull(),
    ...
    cityGroupId: integer("city_group_id").references(() => groups.id, {
      onDelete: "set null",
    }),
...
export const insertScrapedCommunityDataSchema = createInsertSchema(
  scrapedCommunityData,
).omit({ id: true, scrapedAt: true });

export const selectScrapedCommunityDataSchema =
  createSelectSchema(scrapedCommunityData);
export type InsertScrapedCommunityData = z.infer<
  typeof insertScrapedCommunityDataSchema
>;
export type SelectScrapedCommunityData =
  typeof scrapedCommunityData.$inferSelect;

export const scrapedProfiles = pgTable(
  "scraped_profiles",
  {
    id: serial("id").primaryKey(),
...
export const insertScrapedProfileSchema = createInsertSchema(
  scrapedProfiles,
).omit({ id: true, scrapedAt: true });
...
export const codeOfConductAgreements = pgTable(
  "code_of_conduct_agreements",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
...
export const insertCodeOfConductAgreementSchema = createInsertSchema(
  codeOfConductAgreements,
).omit({ id: true, acceptedAt: true });
export const selectCodeOfConductAgreementSchema = createSelectSchema(
  codeOfConductAgreements,
);
export type InsertCodeOfConductAgreement = z.infer<
  typeof insertCodeOfConductAgreementSchema
>;
export type SelectCodeOfConductAgreement =
  typeof codeOfConductAgreements.$inferSelect;

// Housing Revenue Tracking (P0 #4 - Extension)
export const housingBookingPayments = pgTable(
  "housing_booking_payments",
  {
    id: serial("id").primaryKey(),
    bookingId: integer("booking_id")
      .notNull()
      .references(() => housingBookings.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    ...
    stripeIdx: index("housing_payments_stripe_idx").on(
      table.stripePaymentIntentId,
    ),
  }),
);

export const insertHousingBookingPaymentSchema = createInsertSchema(
  housingBookingPayments,
).omit({ id: true, createdAt: true });
export const selectHousingBookingPaymentSchema = createSelectSchema(
  housingBookingPayments,
);
export type InsertHousingBookingPayment = z.infer<
  typeof insertHousingBookingPaymentSchema
>;
export type SelectHousingBookingPayment =
  typeof housingBookingPayments.$inferSelect;

// Event Revenue Tracking (P0 #4 - Extension)
export const eventTicketPurchases = pgTable(
...
export const insertEventTicketPurchaseSchema = createInsertSchema(
  eventTicketPurchases,
).omit({ id: true, createdAt: true });
export const selectEventTicketPurchaseSchema =
  createSelectSchema(eventTicketPurchases);
export type InsertEventTicketPurchase = z.infer<
  typeof insertEventTicketPurchaseSchema
>;
export type SelectEventTicketPurchase =
  typeof eventTicketPurchases.$inferSelect;
...
export const insertPlatformRevenueSchema = createInsertSchema(
  platformRevenue,
...
// Fitness Activities
export const fitnessActivities = pgTable(
  "fitness_activities",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const insertFitnessActivitySchema = createInsertSchema(
  fitnessActivities,
).omit({ id: true, createdAt: true });
export const selectFitnessActivitySchema =
  createSelectSchema(fitnessActivities);
...
export const userPayments = pgTable(
  ...
  (table) => ({
    ...
    stripeIdx: index("user_payments_stripe_idx").on(
      table.stripePaymentIntentId,
    ),
  }),
);
...
export const platformMetrics = pgTable(
  ...
  (table) => ({
    metricNameIdx: index("platform_metrics_metric_name_idx").on(
      table.metricName,
    ),
    metricDateIdx: index("platform_metrics_metric_date_idx").on(
      table.metricDate,
    ),
  }),
);

export const insertPlatformMetricSchema = createInsertSchema(
  platformMetrics,
).omit({ id: true });
...
export const analyticsEvents = pgTable(
  ...
  (table) => ({
    ...
    userEventIdx: index("analytics_events_user_event_idx").on(
      table.userId,
      table.eventType,
    ),
  }),
...
export const userAnalytics = pgTable(
  ...
  (table) => ({
    ...
    lastActiveIdx: index("user_analytics_last_active_idx").on(
      table.lastActiveAt,
    ),
  }),
);
...
export const emailPreferences = pgTable(
  ...
  (table) => ({
    ...
    unsubscribeTokenIdx: index("email_preferences_unsubscribe_token_idx").on(
      table.unsubscribeToken,
    ),
  }),
);

export const insertEmailPreferencesSchema = createInsertSchema(
  emailPreferences,
).omit({ id: true, createdAt: true, updatedAt: true });
export const selectEmailPreferencesSchema =
  createSelectSchema(emailPreferences);
export type InsertEmailPreferences = z.infer<
  typeof insertEmailPreferencesSchema
>;
...
export const uiTestScenarios = pgTable(
  "ui_test_scenarios",
  {
    id: serial("id").primaryKey(),
    title: varchar("title", { length: 255 }).notNull(),
  ...
  (table) => ({
    ...
    difficultyIdx: index("ui_test_scenarios_difficulty_idx").on(
      table.difficulty,
    ),
  }),
);

export const insertUiTestScenarioSchema = createInsertSchema(
  uiTestScenarios,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const uiTestResults = pgTable(
  "ui_test_results",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    scenarioIdIdx: index("ui_test_results_scenario_id_idx").on(
      table.scenarioId,
    ),
    volunteerIdIdx: index("ui_test_results_volunteer_id_idx").on(
      table.volunteerId,
    ),
...
export const insertUiTestResultSchema = createInsertSchema(uiTestResults).omit({
  id: true,
  createdAt: true,
});
...
export const volunteerStats = pgTable(
  ...
  (table) => ({
    ...
    skillLevelIdx: index("volunteer_stats_skill_level_idx").on(
      table.skillLevel,
    ),
    lastActiveAtIdx: index("volunteer_stats_last_active_at_idx").on(
      table.lastActiveAt,
    ),
  }),
);

export const insertVolunteerStatsSchema = createInsertSchema(
  volunteerStats,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const userTestingSessions = pgTable(
  ...
  (table) => ({
    volunteerIdIdx: index("user_testing_sessions_volunteer_id_idx").on(
      table.volunteerId,
    ),
    scenarioIdIdx: index("user_testing_sessions_scenario_id_idx").on(
      table.scenarioId,
    ),
    statusIdx: index("user_testing_sessions_status_idx").on(table.status),
    sessionTypeIdx: index("user_testing_sessions_session_type_idx").on(
      table.sessionType,
    ),
  }),
);

export const insertUserTestingSessionSchema = createInsertSchema(
  userTestingSessions,
).omit({ id: true, createdAt: true });
export const selectUserTestingSessionSchema =
  createSelectSchema(userTestingSessions);
export type InsertUserTestingSession = z.infer<
  typeof insertUserTestingSessionSchema
>;
export type SelectUserTestingSession = typeof userTestingSessions.$inferSelect;

export const sessionInteractions = pgTable(
  ...
  (table) => ({
    sessionIdIdx: index("session_interactions_session_id_idx").on(
      table.sessionId,
    ),
    timestampIdx: index("session_interactions_timestamp_idx").on(
      table.timestamp,
    ),
    interactionTypeIdx: index("session_interactions_interaction_type_idx").on(
      table.interactionType,
    ),
  }),
);

export const insertSessionInteractionSchema = createInsertSchema(
  sessionInteractions,
).omit({ id: true });
export const selectSessionInteractionSchema =
  createSelectSchema(sessionInteractions);
export type InsertSessionInteraction = z.infer<
  typeof insertSessionInteractionSchema
>;
export type SelectSessionInteraction = typeof sessionInteractions.$inferSelect;

export const sessionBugsFound = pgTable(
  "session_bugs_found",
  {
    id: serial("id").primaryKey(),
    sessionId: integer("session_id").references(() => userTestingSessions.id, {
  ...
  (table) => ({
    sessionIdIdx: index("session_bugs_found_session_id_idx").on(
      table.sessionId,
    ),
    volunteerIdIdx: index("session_bugs_found_volunteer_id_idx").on(
      table.volunteerId,
    ),
    ...
    assignedToIdx: index("session_bugs_found_assigned_to_idx").on(
      table.assignedTo,
    ),
  }),
);

export const insertSessionBugFoundSchema = createInsertSchema(
  sessionBugsFound,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const sessionUxPatterns = pgTable(
  "session_ux_patterns",
  {
    id: serial("id").primaryKey(),
    sessionId: integer("session_id").references(() => userTestingSessions.id, {
  ...
  (table) => ({
    sessionIdIdx: index("session_ux_patterns_session_id_idx").on(
      table.sessionId,
    ),
    patternTypeIdx: index("session_ux_patterns_pattern_type_idx").on(
      table.patternType,
    ),
    confidenceIdx: index("session_ux_patterns_confidence_idx").on(
      table.confidence,
    ),
  }),
);

export const insertSessionUxPatternSchema = createInsertSchema(
  sessionUxPatterns,
).omit({ id: true, createdAt: true });
export const selectSessionUxPatternSchema =
  createSelectSchema(sessionUxPatterns);
export type InsertSessionUxPattern = z.infer<
  typeof insertSessionUxPatternSchema
>;
export type SelectSessionUxPattern = typeof sessionUxPatterns.$inferSelect;

// Batch 3: Visual Editor AI Tables

export const visualEditorAiSuggestions = pgTable(
  "visual_editor_ai_suggestions",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
    context: jsonb("context"),
  ...
  (table) => ({
    userIdIdx: index("visual_editor_ai_suggestions_user_id_idx").on(
      table.userId,
    ),
    suggestionTypeIdx: index(
      "visual_editor_ai_suggestions_suggestion_type_idx",
    ).on(table.suggestionType),
    agentIdIdx: index("visual_editor_ai_suggestions_agent_id_idx").on(
      table.agentId,
    ),
    wasHelpfulIdx: index("visual_editor_ai_suggestions_was_helpful_idx").on(
      table.wasHelpful,
    ),
  }),
);

export const insertVisualEditorAiSuggestionSchema = createInsertSchema(
  visualEditorAiSuggestions,
).omit({ id: true, createdAt: true });
export const selectVisualEditorAiSuggestionSchema = createSelectSchema(
  visualEditorAiSuggestions,
);
export type InsertVisualEditorAiSuggestion = z.infer<
  typeof insertVisualEditorAiSuggestionSchema
>;
export type SelectVisualEditorAiSuggestion =
  typeof visualEditorAiSuggestions.$inferSelect;

export const userTelemetry = pgTable(
  "user_telemetry",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
...
export const insertUserTelemetrySchema = createInsertSchema(userTelemetry).omit(
...
export const mrBlueKnowledgeBase = pgTable(
  ...
  (table) => ({
    ...
    categoryIdx: index("mr_blue_knowledge_base_category_idx").on(
      table.category,
    ),
    useCountIdx: index("mr_blue_knowledge_base_use_count_idx").on(
      table.useCount,
    ),
  }),
);

export const insertMrBlueKnowledgeBaseSchema = createInsertSchema(
  mrBlueKnowledgeBase,
).omit({ id: true, createdAt: true, updatedAt: true });
export const selectMrBlueKnowledgeBaseSchema =
  createSelectSchema(mrBlueKnowledgeBase);
export type InsertMrBlueKnowledgeBase = z.infer<
  typeof insertMrBlueKnowledgeBaseSchema
>;
export type SelectMrBlueKnowledgeBase = typeof mrBlueKnowledgeBase.$inferSelect;

export const mrBlueSystemPrompts = pgTable(
  ...
  (table) => ({
    ...
    isActiveIdx: index("mr_blue_system_prompts_is_active_idx").on(
      table.isActive,
    ),
    uniqueAgentVersion: uniqueIndex("unique_agent_version").on(
      table.agentId,
      table.version,
    ),
  }),
...
export const insertMrBlueSystemPromptSchema = createInsertSchema(
  mrBlueSystemPrompts,
).omit({ id: true, createdAt: true });
export const selectMrBlueSystemPromptSchema =
  createSelectSchema(mrBlueSystemPrompts);
export type InsertMrBlueSystemPrompt = z.infer<
  typeof insertMrBlueSystemPromptSchema
>;
...
export const gamificationPoints = pgTable(
  ...
  (table) => ({
    ...
    createdAtIdx: index("gamification_points_created_at_idx").on(
      table.createdAt,
    ),
...
export const insertGamificationPointsSchema = createInsertSchema(
  gamificationPoints,
).omit({ id: true, createdAt: true });
export const selectGamificationPointsSchema =
  createSelectSchema(gamificationPoints);
export type InsertGamificationPoints = z.infer<
  typeof insertGamificationPointsSchema
>;
...
export const selectGamificationBadgeSchema =
  createSelectSchema(gamificationBadges);
export type InsertGamificationBadge = z.infer<
  typeof insertGamificationBadgeSchema
>;
...
export const autonomyProgress = pgTable(
  "autonomy_progress",
  {
    id: serial("id").primaryKey(),
...
export const insertAutonomyProgressSchema = createInsertSchema(
  autonomyProgress,
).omit({ id: true });
export const selectAutonomyProgressSchema =
  createSelectSchema(autonomyProgress);
export type InsertAutonomyProgress = z.infer<
  typeof insertAutonomyProgressSchema
>;
...
export const autonomousTasks = pgTable(
  "autonomous_tasks",
  {
    ...
    actualCost: numeric("actual_cost", { precision: 10, scale: 2 }).default(
      "0.00",
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().notNull(),
...
export const insertAutonomousTaskSchema = createInsertSchema(
  autonomousTasks,
).omit({ createdAt: true, updatedAt: true });
...
export const autonomousTaskFiles = pgTable(
  "autonomous_task_files",
  {
    id: serial("id").primaryKey(),
...
export const insertAutonomousTaskFileSchema = createInsertSchema(
  autonomousTaskFiles,
).omit({ id: true, createdAt: true });
export const selectAutonomousTaskFileSchema =
  createSelectSchema(autonomousTaskFiles);
export type InsertAutonomousTaskFile = z.infer<
  typeof insertAutonomousTaskFileSchema
>;
export type SelectAutonomousTaskFile = typeof autonomousTaskFiles.$inferSelect;

export const autonomousSessions = pgTable(
  "autonomous_sessions",
  {
    id: varchar("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    startedAtIdx: index("autonomous_sessions_started_at_idx").on(
      table.startedAt,
    ),
  }),
);

export const insertAutonomousSessionSchema = createInsertSchema(
  autonomousSessions,
).omit({ startedAt: true });
export const selectAutonomousSessionSchema =
  createSelectSchema(autonomousSessions);
export type InsertAutonomousSession = z.infer<
  typeof insertAutonomousSessionSchema
>;
export type SelectAutonomousSession = typeof autonomousSessions.$inferSelect;

export const autonomousSessionTasks = pgTable(
  "autonomous_session_tasks",
  {
    id: serial("id").primaryKey(),
    sessionId: varchar("session_id")
      .notNull()
      .references(() => autonomousSessions.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    sessionIdx: index("autonomous_session_tasks_session_idx").on(
      table.sessionId,
    ),
    statusIdx: index("autonomous_session_tasks_status_idx").on(table.status),
    sessionTaskIdx: uniqueIndex("unique_session_task").on(
      table.sessionId,
      table.taskNumber,
    ),
  }),
...
export const insertAutonomousSessionTaskSchema = createInsertSchema(
  autonomousSessionTasks,
).omit({ id: true, createdAt: true });
export const selectAutonomousSessionTaskSchema = createSelectSchema(
  autonomousSessionTasks,
);
export type InsertAutonomousSessionTask = z.infer<
  typeof insertAutonomousSessionTaskSchema
>;
export type SelectAutonomousSessionTask =
  typeof autonomousSessionTasks.$inferSelect;
...
export const insertMessengerConnectionSchema = createInsertSchema(
  messengerConnections,
).omit({ id: true, connectedAt: true });
export const selectMessengerConnectionSchema =
  createSelectSchema(messengerConnections);
export type InsertMessengerConnection = z.infer<
  typeof insertMessengerConnectionSchema
>;
export type SelectMessengerConnection =
  typeof messengerConnections.$inferSelect;
...
export const messengerMessages = pgTable(
  ...
  (table) => ({
    connectionIdx: index("messenger_messages_connection_idx").on(
      table.connectionId,
    ),
    conversationIdx: index("messenger_messages_conversation_idx").on(
      table.conversationId,
    ),
...
export const insertMessengerMessageSchema = createInsertSchema(
  messengerMessages,
).omit({ id: true, sentAt: true });
export const selectMessengerMessageSchema =
  createSelectSchema(messengerMessages);
export type InsertMessengerMessage = z.infer<
  typeof insertMessengerMessageSchema
>;
...
export const moderationReports = pgTable(
  ...
  (table) => ({
    ...
    contentIdx: index("moderation_reports_content_idx").on(
      table.contentType,
      table.contentId,
    ),
    statusIdx: index("moderation_reports_status_idx").on(table.status),
    createdAtIdx: index("moderation_reports_created_at_idx").on(
      table.createdAt,
    ),
  }),
);
...
export const insertUserViolationSchema = createInsertSchema(
  userViolations,
).omit({ id: true, timestamp: true });
...
export const insertGeneratedAssetSchema = createInsertSchema(
  generatedAssets,
).omit({ id: true, createdAt: true });
...
export const assetGenerationJobs = pgTable(
  ...
  (table) => ({
    ...
    createdAtIdx: index("asset_generation_jobs_created_at_idx").on(
      table.createdAt,
    ),
  }),
);

export const insertAssetGenerationJobSchema = createInsertSchema(
  assetGenerationJobs,
).omit({ id: true, createdAt: true });
export type InsertAssetGenerationJob = z.infer<
  typeof insertAssetGenerationJobSchema
>;
...
// Distraction Logs
export const distractionLogs = pgTable(
  "distraction_logs",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const insertDistractionLogSchema = createInsertSchema(
  distractionLogs,
).omit({ id: true });
...
export const productivityReports = pgTable(
...
export const insertProductivityReportSchema = createInsertSchema(
  productivityReports,
).omit({ id: true, createdAt: true });
export type InsertProductivityReport = z.infer<
  typeof insertProductivityReportSchema
>;
...
export const financialTransactions = pgTable(
  ...
  (table) => ({
    ...
    categoryIdx: index("financial_transactions_category_idx").on(
      table.category,
    ),
...
>;
export type SelectFinancialTransaction =
...
export const outreachSequences = pgTable(
  ...
  (table) => ({
    ...
    candidateIdx: index("outreach_sequences_candidate_idx").on(
      table.candidateId,
    ),
...
export const insertOutreachStepSchema = createInsertSchema(outreachSteps).omit({
  id: true,
});
...
export const candidatePipelines = pgTable(
  "candidate_pipelines",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }), // Recruiter
    candidateId: integer("candidate_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    ...
    candidateIdx: index("candidate_pipelines_candidate_idx").on(
      table.candidateId,
    ),
...
export const insertCandidatePipelineSchema = createInsertSchema(
  candidatePipelines,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertCandidatePipeline = z.infer<
  typeof insertCandidatePipelineSchema
>;
...
export const virtualEmails = pgTable(
  "virtual_emails",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    virtualEmailIdx: uniqueIndex("virtual_emails_virtual_email_idx").on(
      table.virtualEmail,
    ),
...
export const insertVirtualEmailSchema = createInsertSchema(virtualEmails).omit({
  id: true,
  createdAt: true,
});
...
// Virtual Email Logs
export const virtualEmailLogs = pgTable(
  "virtual_email_logs",
  {
    id: serial("id").primaryKey(),
    virtualEmailId: integer("virtual_email_id")
      .notNull()
      .references(() => virtualEmails.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    virtualEmailIdx: index("virtual_email_logs_virtual_email_idx").on(
      table.virtualEmailId,
    ),
    receivedAtIdx: index("virtual_email_logs_received_at_idx").on(
      table.receivedAt,
    ),
  }),
);

export const insertVirtualEmailLogSchema = createInsertSchema(
  virtualEmailLogs,
).omit({ id: true });
...
export const dataBrokerRemovalRequests = pgTable(
  "data_broker_removal_requests",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    ...
    statusIdx: index("data_broker_removal_requests_status_idx").on(
      table.status,
    ),
  }),
);

export const insertDataBrokerRemovalRequestSchema = createInsertSchema(
  dataBrokerRemovalRequests,
).omit({ id: true });
export type InsertDataBrokerRemovalRequest = z.infer<
  typeof insertDataBrokerRemovalRequestSchema
>;
export type SelectDataBrokerRemovalRequest =
  typeof dataBrokerRemovalRequests.$inferSelect;
...
export const friendInvitations = pgTable(
  "friend_invitations",
  {
    ...
    invitedBy: integer("invited_by")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    invitedFriendName: varchar("invited_friend_name", {
      length: 255,
    }).notNull(),
    invitedFriendEmail: varchar("invited_friend_email", { length: 255 }),
    invitedFriendFacebookId: varchar("invited_friend_facebook_id", {
      length: 100,
    }),
  ...
  (table) => ({
    invitedByIdx: index("friend_invitations_invited_by_idx").on(
      table.invitedBy,
    ),
    inviteCodeIdx: uniqueIndex("friend_invitations_invite_code_idx").on(
      table.inviteCode,
    ),
    emailIdx: index("friend_invitations_email_idx").on(
      table.invitedFriendEmail,
    ),
    facebookIdIdx: index("friend_invitations_facebook_id_idx").on(
      table.invitedFriendFacebookId,
    ),
    sentAtIdx: index("friend_invitations_sent_at_idx").on(table.sentAt),
  }),
);

export const insertFriendInvitationSchema = createInsertSchema(
  friendInvitations,
).omit({ id: true, sentAt: true });
export type InsertFriendInvitation = z.infer<
  typeof insertFriendInvitationSchema
>;
...
export const insertSocialMessageSchema = createInsertSchema(
  socialMessages,
).omit({ id: true, createdAt: true });
...
export const friendCloseness = pgTable(
  "friend_closeness",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    friendNameIdx: index("friend_closeness_friend_name_idx").on(
      table.friendName,
    ),
...
export const insertFriendClosenessSchema = createInsertSchema(
  friendCloseness,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const professionalEndorsements = pgTable(
  "professional_endorsements",
  {
    id: serial("id").primaryKey(),
    endorseeId: integer("endorsee_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    endorserId: integer("endorser_id")
      .notNull()
  ...
  (table) => ({
    endorseeIdx: index("professional_endorsements_endorsee_idx").on(
      table.endorseeId,
    ),
    endorserIdx: index("professional_endorsements_endorser_idx").on(
      table.endorserId,
    ),
    roleIdx: index("professional_endorsements_role_idx").on(table.tangoRole),
    uniqueEndorsement: unique().on(
      table.endorseeId,
      table.endorserId,
      table.tangoRole,
      table.skillType,
...
export const insertProfessionalEndorsementSchema = createInsertSchema(
  professionalEndorsements,
).omit({ id: true, createdAt: true });
export type InsertProfessionalEndorsement = z.infer<
  typeof insertProfessionalEndorsementSchema
>;
export type SelectProfessionalEndorsement =
  typeof professionalEndorsements.$inferSelect;

// Mr Blue Tours - Tour tracking system
export const mrBlueTours = pgTable(
  "mr_blue_tours",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
...
export const insertMrBlueTourSchema = createInsertSchema(mrBlueTours).omit({
  id: true,
  createdAt: true,
});
...
export const tourSentiment = pgTable(
  "tour_sentiment",
  {
    id: serial("id").primaryKey(),
    tourId: integer("tour_id")
      .notNull()
      .references(() => mrBlueTours.id, { onDelete: "cascade" }),
...
export const insertTourSentimentSchema = createInsertSchema(tourSentiment).omit(
  { id: true, timestamp: true },
);
...
export const insertPlanProgressSchema = createInsertSchema(planProgress).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertMonitoringAlertSchema = createInsertSchema(
  monitoringAlerts,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const journeyEntries = pgTable(
  ...
  (table) => ({
    ...
    significanceIdx: index("journey_entries_significance_idx").on(
      table.significance,
    ),
    bookChapterIdx: index("journey_entries_book_chapter_idx").on(
      table.bookChapter,
    ),
...
export const insertJourneyEntrySchema = createInsertSchema(journeyEntries).omit(
  { id: true, createdAt: true, updatedAt: true },
);
...
export const computerUseTasks = pgTable(
  "computer_use_tasks",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    ...
    createdAtIdx: index("computer_use_tasks_created_at_idx").on(
      table.createdAt,
    ),
    automationTypeIdx: index("computer_use_tasks_automation_type_idx").on(
      table.automationType,
    ),
  }),
);

export const insertComputerUseTaskSchema = createInsertSchema(
  computerUseTasks,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const computerUseScreenshots = pgTable(
  "computer_use_screenshots",
  {
    id: serial("id").primaryKey(),
    taskId: integer("task_id")
      .notNull()
      .references(() => computerUseTasks.id, { onDelete: "cascade" }),
    stepNumber: integer("step_number").notNull(),
  ...
  (table) => ({
    ...
    stepNumberIdx: index("computer_use_screenshots_step_number_idx").on(
      table.stepNumber,
    ),
  }),
);

export const insertComputerUseScreenshotSchema = createInsertSchema(
  computerUseScreenshots,
).omit({ id: true, createdAt: true });
export type InsertComputerUseScreenshot = z.infer<
  typeof insertComputerUseScreenshotSchema
>;
export type SelectComputerUseScreenshot =
  typeof computerUseScreenshots.$inferSelect;
...
export const facebookInvites = pgTable(
  "facebook_invites",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    userSentAtIdx: index("facebook_invites_user_sent_at_idx").on(
      table.userId,
      table.sentAt,
...
export const insertFacebookInviteSchema = createInsertSchema(
  facebookInvites,
).omit({ id: true, sentAt: true });
...
export const agentEpisodicMemory = pgTable(
  ...
  (table) => ({
    agentPageIdx: index("episodic_agent_page_idx").on(
      table.agentId,
      table.pageId,
    ),
...
export const insertAgentEpisodicMemorySchema = createInsertSchema(
  agentEpisodicMemory,
).omit({ id: true, timestamp: true });
export type InsertAgentEpisodicMemory = z.infer<
  typeof insertAgentEpisodicMemorySchema
>;
export type SelectAgentEpisodicMemory = typeof agentEpisodicMemory.$inferSelect;

export const agentSemanticMemory = pgTable(
  ...
  (table) => ({
    agentConceptIdx: uniqueIndex("semantic_agent_concept_idx").on(
      table.agentId,
      table.concept,
    ),
...
export const insertAgentSemanticMemorySchema = createInsertSchema(
  agentSemanticMemory,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertAgentSemanticMemory = z.infer<
  typeof insertAgentSemanticMemorySchema
>;
export type SelectAgentSemanticMemory = typeof agentSemanticMemory.$inferSelect;

export const agentProceduralMemory = pgTable(
...
export const insertAgentProceduralMemorySchema = createInsertSchema(
  agentProceduralMemory,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertAgentProceduralMemory = z.infer<
  typeof insertAgentProceduralMemorySchema
>;
export type SelectAgentProceduralMemory =
  typeof agentProceduralMemory.$inferSelect;
...
export const agentStateCheckpoints = pgTable(
...
export const insertAgentStateCheckpointSchema = createInsertSchema(
  agentStateCheckpoints,
).omit({ id: true, createdAt: true });
export type InsertAgentStateCheckpoint = z.infer<
  typeof insertAgentStateCheckpointSchema
>;
export type SelectAgentStateCheckpoint =
  typeof agentStateCheckpoints.$inferSelect;
...
export const agentOperationMetrics = pgTable(
  "agent_operation_metrics",
  {
    id: serial("id").primaryKey(),
    agentId: varchar("agent_id", { length: 100 }).notNull(),
  ...
  (table) => ({
    agentOpIdx: index("metrics_agent_op_idx").on(
      table.agentId,
      table.operation,
    ),
...
export const insertAgentOperationMetricSchema = createInsertSchema(
  agentOperationMetrics,
).omit({ id: true, timestamp: true });
export type InsertAgentOperationMetric = z.infer<
  typeof insertAgentOperationMetricSchema
>;
export type SelectAgentOperationMetric =
  typeof agentOperationMetrics.$inferSelect;

// Agent cost budgets (SuperAGI pattern)
export const agentCostBudgets = pgTable(
  "agent_cost_budgets",
  {
    id: serial("id").primaryKey(),
...
export const insertAgentCostBudgetSchema = createInsertSchema(
  agentCostBudgets,
).omit({ id: true, updatedAt: true });
...
export const clarificationRounds = pgTable(
  ...
  (table) => ({
    conversationIdx: index("clarification_rounds_conversation_idx").on(
      table.conversationId,
    ),
    completedIdx: index("clarification_rounds_completed_idx").on(
      table.completed,
    ),
  }),
);

export const insertClarificationRoundSchema = createInsertSchema(
  clarificationRounds,
).omit({ id: true, createdAt: true });
export type InsertClarificationRound = z.infer<
  typeof insertClarificationRoundSchema
>;
export type SelectClarificationRound = typeof clarificationRounds.$inferSelect;

export const autoCommits = pgTable(
  "auto_commits",
  {
    id: serial("id").primaryKey(),
...
export const insertAutoCommitSchema = createInsertSchema(autoCommits).omit({
  id: true,
  createdAt: true,
});
...
export const insertDeploymentCheckSchema = createInsertSchema(
  deploymentChecks,
).omit({ id: true, createdAt: true });
...
export const agentCards = pgTable(
  ...
  (table) => ({
    ...
    capabilitiesIdx: index("agent_cards_capabilities_idx").on(
      table.capabilities,
    ),
  }),
);

export const insertAgentCardSchema = createInsertSchema(agentCards).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const a2aMessages = pgTable(
  ...
  (table) => ({
    messageIdIdx: uniqueIndex("a2a_messages_message_id_idx").on(
      table.messageId,
    ),
    agentsIdx: index("a2a_messages_agents_idx").on(
      table.fromAgent,
      table.toAgent,
    ),
...
export const insertA2AMessageSchema = createInsertSchema(a2aMessages).omit({
  id: true,
  createdAt: true,
});
...
export const insertWorkflowExecutionSchema = createInsertSchema(
  workflowExecutions,
...
export const invitationBatches = pgTable(
  "invitation_batches",
  {
    ...
    platform: varchar("platform", { length: 50 })
      ...
      .notNull(), // facebook_messenger, whatsapp, email
  ...
  (table) => ({
    ...
    scheduledIdx: index("invitation_batches_scheduled_idx").on(
      table.scheduledFor,
    ),
...
export const insertInvitationBatchSchema = createInsertSchema(
  invitationBatches,
...
export const batchInvitations = pgTable(
  "batch_invitations",
  {
    id: serial("id").primaryKey(),
...
export const insertBatchInvitationSchema = createInsertSchema(
  batchInvitations,
).omit({ id: true, createdAt: true, sentAt: true });
...
export const tangoResumes = pgTable(
  "tango_resumes",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
  ...
  (table) => ({
    ...
    availabilityIdx: index("tango_resumes_availability_idx").on(
      table.availability,
    ),
...
export const insertTangoResumeSchema = createInsertSchema(tangoResumes).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const roleConfirmations = pgTable(
  "role_confirmations",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }), // User being confirmed
    confirmerId: integer("confirmer_id")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }), // User confirming
    tangoRole: varchar("tango_role", { length: 50 }).notNull(), // 'teacher', 'dj', 'organizer', 'performer'
  ...
  (table) => ({
    ...
    confirmerIdx: index("role_confirmations_confirmer_idx").on(
      table.confirmerId,
    ),
    roleIdx: index("role_confirmations_role_idx").on(table.tangoRole),
    uniqueConfirmation: unique().on(
      table.userId,
      table.confirmerId,
      table.tangoRole,
    ),
...
export const insertRoleConfirmationSchema = createInsertSchema(
  roleConfirmations,
).omit({ id: true, createdAt: true });
export type InsertRoleConfirmation = z.infer<
  typeof insertRoleConfirmationSchema
>;
...
export const mrBlueUserPreferences = pgTable(
  "mr_blue_user_preferences",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
...
export const insertMrBlueUserPreferenceSchema = createInsertSchema(
  mrBlueUserPreferences,
).omit({ id: true, detectedAt: true, lastDetectedAt: true });
export type InsertMrBlueUserPreference = z.infer<
  typeof insertMrBlueUserPreferenceSchema
>;
export type SelectMrBlueUserPreference =
  typeof mrBlueUserPreferences.$inferSelect;

// Workflow Actions - User action recording for pattern learning (Agent #46)
export const mrBlueWorkflowActions = pgTable(
  "mr_blue_workflow_actions",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    ...
    sessionIdx: index("mr_blue_workflow_actions_session_idx").on(
      table.sessionId,
    ),
    typeIdx: index("mr_blue_workflow_actions_type_idx").on(table.actionType),
    performedAtIdx: index("mr_blue_workflow_actions_performed_at_idx").on(
      table.performedAt,
    ),
  }),
);

export const insertMrBlueWorkflowActionSchema = createInsertSchema(
  mrBlueWorkflowActions,
).omit({ id: true, performedAt: true });
export type InsertMrBlueWorkflowAction = z.infer<
  typeof insertMrBlueWorkflowActionSchema
>;
export type SelectMrBlueWorkflowAction =
  typeof mrBlueWorkflowActions.$inferSelect;

// Workflow Patterns - Learned action sequences (Agent #46)
export const mrBlueWorkflowPatterns = pgTable(
  "mr_blue_workflow_patterns",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id")
      .notNull()
  ...
  (table) => ({
    ...
    sequenceIdx: index("mr_blue_workflow_patterns_sequence_idx").on(
      table.actionSequence,
    ),
    confidenceIdx: index("mr_blue_workflow_patterns_confidence_idx").on(
      table.confidence,
    ),
...
export const insertMrBlueWorkflowPatternSchema = createInsertSchema(
  mrBlueWorkflowPatterns,
).omit({ id: true, lastOccurred: true });
export type InsertMrBlueWorkflowPattern = z.infer<
  typeof insertMrBlueWorkflowPatternSchema
>;
export type SelectMrBlueWorkflowPattern =
