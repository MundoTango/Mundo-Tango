...
import { chatFeedbackPathway } from "./chatFeedbackPathway";
import { volunteerTestingPathway } from "./volunteerTestingPathway";
import { liveSessionPathway } from "./liveSessionPathway";
import { visualEditorPathway } from "./visualEditorPathway";
import { telemetryPathway } from "./telemetryPathway";
import { codeGenerationPathway } from "./codeGenerationPathway";
import { tourCompletionPathway } from "./tourCompletionPathway";
import { featureUsagePathway } from "./featureUsagePathway";
import { errorPatternPathway } from "./errorPatternPathway";
import { socialSentimentPathway } from "./socialSentimentPathway";
...
export const learningCoordinatorService = new LearningCoordinator();
