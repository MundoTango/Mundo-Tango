...
// import { gitService } from './gitService'; // TODO: gitService doesn't exist in server/
...
class AutonomousAgent {
  ...
  async getCurrentBranch(): Promise<string> {
    // TODO: gitService doesn't exist - using git command instead
    const { stdout } = await this.executeCommand('git branch --show-current');
    return stdout.trim();
  }
