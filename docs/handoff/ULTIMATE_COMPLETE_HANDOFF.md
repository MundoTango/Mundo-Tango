# 🌎 MUNDO TANGO: ULTIMATE COMPLETE HANDOFF
...
## ⚡ Performance Optimizations (All 12)
...
## ⚠️ CRITICAL: READ BEFORE ANY CODE
...
**ALLOWED ✅:**
- User-initiated "Download Your Information" → parse JSON
...
**What's ALLOWED:**
✅ User-initiated data export (facebook.com/dyi)  
✅ Facebook Graph API with OAuth  
✅ Public event data (limited)

**What's PROHIBITED:**
❌ Automated Playwright scraping without consent  
❌ Storing data longer than 90 days  
...
- [ ] ✅ User consent flows for FB/IG/WhatsApp
- [ ] ✅ Data retention: 90-day TTL on social data
- [ ] ✅ User rights: Access, Deletion, Portability, Correction
- [ ] ✅ Encryption: At rest (AES-256), In transit (TLS 1.3)
- [ ] ✅ Facebook TOS compliance (no prohibited scraping)
- [ ] ✅ Database RLS enabled (user data isolated)
...
export function VideoConference() {
  ...
  return (
    <div>
      {!inCall ? (
        <Button onClick={startCall}>📹 Video Call Mr Blue</Button>
      ) : (
...
**Purpose:** Natural language → production code
...
4. Vibe Coding Engine (natural language → code)
...
server/
  ...
  ├── middleware/         # Auth, CSRF, tier enforcement
  ├── services/           # Business logic
  │   └── mr-blue/        # Mr Blue 8 systems
  ├── scrapers/           # FB event scraping
  └── jobs/               # Background tasks

client/src/
  ├── pages/              # Route components
  ├── components/         # Reusable UI
  │   └── mr-blue/        # Mr Blue UI components
...
# LET'S BUILD MUNDO TANGO 🌎

**You have everything you need:**
- ✅ Complete methodology (MB.MD v6.0)
- ✅ Legal compliance guide (GDPR + FB TOS)
- ✅ Week 1-20 roadmap
- ✅ Mr Blue 8 systems (full code)
- ✅ 927 features catalog
- ✅ Code templates (70% time savings)
- ✅ Success criteria
